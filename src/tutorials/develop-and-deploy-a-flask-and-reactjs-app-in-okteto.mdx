...
description: Learn how to build an application with Flask and ReactJS directly in Okteto.
---
...
In this article, you build a TODO list application directly in Okteto using an [Okteto Development Environment](/docs/development) with the Flask framework and ReactJS library.
...
First, [install the Okteto CLI](/docs/get-started/install-okteto-cli) to access Okteto's development environment.

Next, configure the Okteto CLI to point to your Okteto instance:
...
After executing that, your Docker Compose file is deployed and built on Okteto.

Go to your Okteto dashboard and you'll see that your application is deployed successfully:
...
```
 i  Using khabdrick @ okteto.example.com as context
...
Now your development environment is running on Okteto.
