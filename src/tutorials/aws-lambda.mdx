...
Okteto needs sufficient permissions to make necessary AWS service calls and manage AWS resources to create the Lambda Function in your AWS account. This can be done  by [configuring Cloud Credentials](/docs/admin/cloud-credentials/aws).
