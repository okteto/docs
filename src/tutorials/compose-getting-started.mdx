...
[Docker Compose](/docs/reference/docker-compose) are for developers who don't want to deal with the complexities of Kubernetes manifests.
...
- Install the Okteto CLI. Follow this [guide](/docs/development/using-okteto-cli) if you haven't done it yet.
- Configure Access to your Okteto Namespace [using the Okteto CLI](/docs/core/credentials/kubernetes-credentials#download-your-kubernetes-credentials-using-the-okteto-cli) or [using the Okteto dashboard](/docs/core/credentials/kubernetes-credentials).
...
Open your browser and go to the URL of your development environment, shown as part of the `okteto deploy` logs (https://vote-cindy.okteto.example.com/ in this case).
...
Read the docs for the [Docker Compose](/docs/reference/docker-compose) and the [available Okteto CLI commands](/docs/reference/okteto-cli) to learn more about developing your Docker Compose application on Okteto.

Head over to [our getting started guides](/docs/development/containers) to see how to configure Okteto to live-update your application with different programming languages and **debuggers**.
