...
Data cloning allows you to create an independent, identical copy of an application’s database, making it easy to test with realistic data.
...
Create a new manifest file `snapshot.yml` and add the following to it:
...
📖 Next Steps: [Explore more on Okteto Volume Snapshots](https://www.okteto.com/docs/core/use-volume-snapshots/)
