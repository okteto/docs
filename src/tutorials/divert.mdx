...
:::tip
Learn more about Divert's architecture and traffic routing in the [Divert core concepts guide](/docs/1.41/core/divert/).
:::
...
- Learn about [Divert Core Concepts](/docs/1.41/core/divert/) for architecture details
- Explore [Using Divert](/docs/1.41/development/using-divert/) for advanced configuration
- Try [okteto up](/docs/1.41/development/containers/file-sync/) for live code synchronization
