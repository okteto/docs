...
<Image
  ...
  alt="Okteto dashboard showing deployed LaunchDarkly dev environments with endpoints, repository link, and deployment logs"
/>
...
<Image
  ...
  alt="LaunchDarkly Feature flags dashboard showing the Use new emojis flag toggled on"
/>
