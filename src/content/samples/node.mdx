...
At the root of the directory, you'll find the `okteto.yaml` file. This describes how to [build](reference/okteto-manifest/#build-object-optional) and [deploy](reference/okteto-manifest/#deploy-string-optional) the Node Sample App.
...
```console
 ...
 i  Building the image 'okteto.dev/node-hello-world:1.0.0' in tcp://buildkit.example.okteto.com:1234...
[+] Building 5.9s (11/11) FINISHED
 ...
 ✓  Image 'registry.example.okteto.com/cindy/node-hello-world:1.0.0' successfully pushed
...
The [dev](reference/okteto-manifest/#dev-object-optional) section defines how to activate a development container for the Node Sample App:
```
dev:
  hello-world:
    command: bash
