...
```console
 ...
 i  Building the image 'okteto.dev/hello-world:dev' in tcp://buildkit.cloud.okteto.net:1234...
...
 ✓  Image 'registry.cloud.okteto.net/cindy/hello-world:dev' successfully pushed
 i  Running cat k8s-template.yml | envsubst | kubectl apply -f -
