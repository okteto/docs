...
```console
 ...
 i  Building the image 'okteto.dev/hello-world:1.0.0' in tcp://buildkit.cloud.okteto.net:1234...
...
 ✓  Image 'registry.cloud.okteto.net/cindy/hello-world:1.0.0' successfully pushed
