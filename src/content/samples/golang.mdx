...
The `okteto.yml` file describes how to [build](/docs/reference/manifest/#build-object-optional) and [deploy](/docs/reference/manifest/#deploy-string-optional) the Go Sample App.
...
The [dev](http://localhost:8080/docs/reference/manifest/#dev-object-optional) section defines how to activate a development container for the Go Sample App:
