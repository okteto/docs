...
- Install the latest version of the Okteto CLI. Follow this [guide](deploy/using-the-cli.mdx) if you haven't done it yet.
- Configure Access to your Okteto Cloud Namespace [using the Okteto CLI](deploy/components/kubernetes-credentials.mdx#download-your-kubernetes-credentials-using-the-okteto-cli) or [using the Okteto UI](deploy/components/kubernetes-credentials.mdx#download-your-kubernetes-credentials-from-the-okteto-cloud-ui).
