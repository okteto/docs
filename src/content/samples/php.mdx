...
At the root of the directory, you'll find the `okteto.yaml` file. This describes how to [build](reference/okteto-manifest/#build-object-optional) and [deploy](reference/okteto-manifest/#deploy-string-optional) the Php Sample App.
...
The [dev](reference/okteto-manifest/#dev-object-optional) section defines how to activate a development container for the Php Sample App:
```
dev:
  hello-world:
