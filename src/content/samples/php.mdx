...
build:
  hello-world:
    ...
    context: .
  hello-world-dev:
    image: okteto.dev/php-hello-world:dev
    context: .
    target: dev
deploy:
...
- `image`: the image used by the development container. More information on development images [here](https://www.okteto.com/docs/reference/manifest/#image-string-optional).
