...
|---------|--------------|-------------|
| `okteto down` | Exits dev mode for one service and restores the original deployment. Does not destroy the environment. | The developer is done iterating on a service but wants the environment running. |
