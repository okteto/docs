...
Okteto tracks resources deployed through `okteto deploy`. If an agent uses `kubectl` or `helm` directly, Okteto loses track of those resources and can't clean them up or show them in the Dashboard.
