...
[Follow the process in this guide to create a personal access token](core/credentials/personal-access-tokens). Once you've created the personal access token, add it to your GitHub repository following the instructions [here](https://docs.github.com/en/actions/security-guides/encrypted-secrets#creating-encrypted-secrets-for-a-repository).
