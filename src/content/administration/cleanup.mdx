...
## Persistent resources <TiersList tiers="Scale Enterprise" />
...
You can enable and customize the `inactivity` and `deletion` periods via the [garbage collector's settings](/docs/enterprise/administration/configuration/#gc).

</TabItem>

<TabItem value="saas">
If your instance is hosted by Okteto, reach out to support@okteto.com to modify this configuration.
</TabItem>
</Tabs>
