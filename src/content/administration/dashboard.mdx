...
This section in the admin view allows you to see the registry credentials that have been [configured through the helm chart](/self-hosted/administration/configuration/#privateregistry). You will see a row for each configured registry with the type (Static or AWS) and the registry hostname. The 2 types of credentials supported are:
...
<p align="center"><Image src="/docs/administration/images/registry_credentials_view.png" alt="Registry credentials view" width="700" /></p>

For each configured registry you can see the non-sensible information like username or hostname. For sensible data you can only see some of the last characters as a hint to verify the value.

<p align="center"><Image src="/docs/administration/images/registry_credentials_detail.png" alt="Registry credentials detail" width="800" /></p>