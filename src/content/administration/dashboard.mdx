...
This section of the Admin dashboard simplifies the configuration of these credentials in Okteto, but you can managed them in an advanced way creating directly Kubernetes resources. This is useful, for example, if you have your own mechanism to provision secrets in the cluster.
