...
You can configure your instance of Okteto to use a GitHub Application to authenticate your users as well as give them access to private GitHub repositories. 
...
## Adding or removing private repositories <TiersList tiers="All Tiers" />
...
<p align="center"><Image src="/docs/enterprise/administration/private-repositories/images/private-repositories-enable.png" alt="add repositories to Okteto Enterprise" width="650" /></p>
...
Setting up a GitHub Application requires several steps in both GitHub and your Okteto instance. Complete the following steps in GitHub:
...
If you are hosting your own instance of Okteto, complete the following steps:
...
If you are using a SaaS instance, reach out to support@okteto.com to complete the configuration.
...
Add the values we generated in the previous steps to your existing [Helm configuration file](/docs/enterprise/install/deployment/#configuration-file).
...
> You can also use the appId and clientId values of your GitHub application in the `auth.github` section of your Helm configuration file if you're using GitHub as your [authentication provider](/docs/enterprise/install/deployment/#authentication).
...
<TabItem value="saas">
If your instance is hosted by Okteto, reach out to support@okteto.com to finalized the configuration.
</TabItem>
</Tabs>
...
<p align="center"><Image src="/docs/enterprise/administration/private-repositories/images/verify-installation.png" alt="verify your installation" width="650" /></p>
