...
Okteto offers two different approaches to service development: *sync* ot *hybrid* mode. The command affected by this is the [`okteto up`](/reference/okteto-cli.mdx/#up) command being configurable at manifest level.
...
<p align="center">
  <Image
    src={require("@site/static/img/hybrid-development.png").default}
