...
To do this you can make use of the [reverse](reference/otketo-manifest.mdx/#reverse-string-optional) field in your Okteto manifest, which will expose the configured port of your local machine to the desired port on the development container.
