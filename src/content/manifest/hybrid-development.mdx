...
Okteto offers two different approaches to service development: sync ot hybrid mode. The command affected by this is the [`okteto up`](/reference/cli/#up) command but it is at the manifest level where this feature is configured.
