...
This section tells Okteto how to deploy your application. It typically uses a combination of `helm`, `kubectl`, and `okteto` commands. You can execute multiple commands and label each command with a name.
