...
1.  An AWS account
1.  An Okteto account
1.  Create a set of [IAM keys](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_access-keys.html) for your AWS account (If you are using Okteto Self-Hosted, you can [directly assign an AWS Role](/get-started/preparation.mdx#creating-an-iam))
