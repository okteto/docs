...
You can also use `SSH` authentication to deploy a private repository. To do this, use the `SSH` url of your git repository. This applies both when using the [`Deploy`](/docs/cloud/deploy-from-git) dialog in the dashboard and the [`okteto pipeline deploy`](/docs/reference/cli#deploy) command from your terminal.
...
[This document](/docs/administration/private-repositories/ssh-key/) has more information on how to configure access to the private repository in your source code provider.
