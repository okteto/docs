...
After giving Okteto access to any of your public or private repositories, you'll be able to deploy from a GitHub repository [using an Okteto Manifest](/docs/cloud/deploy-from-git/).
