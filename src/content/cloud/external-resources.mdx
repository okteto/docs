...
**Image Placeholder: show where content will appear**
...
**Image Placeholder: show example of icon on an external resource**
...
**Image Placeholder: Architecture image from the demo repo**
