---
title: Deploy Applications from Helm Charts
...
Log in to [Okteto Cloud](https://cloud.okteto.com), and click on the **Deploy** button on the top left. A deploy dialog will open.
