...
You can also list your own charts under the [Helm Catalog](/docs/self-hosted/administration/configuration/#applications) tab of the **Launch Dev Environment** menu.
This would give you the same one-click deployment experience for your own services when using [Okteto Self-Hosted](/docs/self-hosted/).
