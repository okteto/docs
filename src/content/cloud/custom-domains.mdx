...
If you're using Okteto's [auto-ingress](core/ingress/automatic-ssl.mdx) or [generate the host](core/ingress/automatic-ssl.mdx#let-okteto-generate-the-host) features, then there's nothing to change. Just redeploy your application, and it will automatically pick up your custom domain.
