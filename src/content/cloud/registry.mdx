...
Just as we can push images to the Okteto Registry, you also have the option to push Helm charts. To do this, the first step is to log in to the registry where we want to push the chart:
