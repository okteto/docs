...
```
helm push ./movies-api-0.1.0.tgz oci://registry.cloud.okteto.net/cindy-namespace
```

Once the packaged chart has been pushed to the Okteto Registry, you can pull it by using the command below:

```
helm pull oci://registry.cloud.okteto.net/cindy-namespace/movies-api --version 0.1.0
```
