...
Read the Okteto Pipeline [getting started guide](/docs/cloud/okteto-cli/#okteto-manifest) to learn how to create an Okteto Pipeline for your Git repository. -->

## Prerequisites

Please make sure to configure your Git repositories with the [appropriate manifests](/docs/cloud/okteto-cli/#deployment-manifests) before using them to launch Dev Environments.
