---
title: Preview Environments with GitHub
...
[Follow the process in this guide to create a personal access token](https://okteto.com/docs/cloud/personal-access-tokens/).
