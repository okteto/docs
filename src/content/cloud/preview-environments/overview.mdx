...
Preview environments deploy the code in a pull request to [Okteto Cloud](/docs/cloud/) or [Self-Hosted](/docs/enterprise/). You can configure the way your code gets deployed using an [Okteto manifest](/docs/cloud/okteto-pipeline/). This is the same file that you can use to define your [Dev Environments](/docs/reference/development-environment/).
