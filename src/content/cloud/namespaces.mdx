...
SaaS single tenant and Self-Hosted customers can specify a global, default threshold for automatically sleeping a namespace in the [garbage collection](/self-hosted/administration/configuration/#gc) configuration.
