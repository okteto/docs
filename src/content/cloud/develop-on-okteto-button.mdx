...
- `filename`: The location of the [Okteto manifest](reference/manifest.mdx) relative to the root of the repository. If not set, one of the [deployment related manifests](core/using-okteto-cli.mdx#deployment-manifests) will be used.
