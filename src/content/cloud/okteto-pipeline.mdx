...
- `OKTETO_DOMAIN`: the configured domain for your application endpoints. You can use this to calculate your application's endpoints by using `SERVICE_NAME-${OKTETO_NAMESPACE}.${OKTETO_DOMAIN}`.
