...
Okteto CLI is an [open source](https://github.com/okteto/okteto) client-side only tool that allows you to launch Dev Environments in any Kubernetes cluster: your own, [Okteto Cloud](index.md), [Okteto SaaS](saas-vs-self-hosted.mdx), or [Okteto Self-Hosted](self-hosted.mdx).
