...
You need some kind of deployment manifests for your application so that Okteto CLI knows how to deploy your application to a Dev Environment. Unless you are using Docker Compose Manifests, Okteto CLI will analyze your existing manifests (Helm, Kubernetes, etc.) and help you write an [Okteto Manifest](#okteto-manifest) for your application. It will then use this Okteto Manifest instead of your existing deployment manifests to spin up Dev Environments. If you're using Docker Compose Manifests, then Okteto CLI can create a Dev Environment for your application directly - without you having to generate an Okteto Manifest. However, you can still choose to create the Okteto Manifest if you want more configuration over your environment. Okteto CLI will look for deployment manifests for your application in the following order:
...
The Okteto Manifest allows you to provide configuration for building, deploying, and developing your application in a Development Environment. While [deployment manifests](#deployment-manifests) simply let Okteto CLI know how to deploy your application to the Dev Environment, the Okteto Manifest lets you configure various other settings for your Dev Environment. 
