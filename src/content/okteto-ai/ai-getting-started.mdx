...
description: Launch and configure AI agents from the Okteto Dashboard.
sidebar_label: Getting Started
id: ai-getting-started
---

Okteto AI agents run in fully isolated Development Environments and can read your codebase, install dependencies, write code, and run tests -- all from the Okteto Dashboard.

## Prerequisites

- An administrator has [enabled Okteto AI](okteto-ai/okteto-ai-admin-config.mdx) for your organization
- You have access to the Okteto Dashboard
- The **Agents** tab is visible in your dashboard

If you do not see the **Agents** tab, contact your administrator to request access.
...
**Start fresh** — select **Start a new project** and describe what you want to build. The agent will create everything from scratch.
