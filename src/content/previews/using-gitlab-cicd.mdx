...
review:
  ...
  script:
    ...
    # optional
    # Run integration tests against your newly create preview environment
    - okteto test --name "review-$CI_COMMIT_REF_SLUG" --var USER=admin --var PASS=admin integration 
