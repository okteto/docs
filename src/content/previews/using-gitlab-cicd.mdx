...
1. Expand the **Variables** section, and click on the **Add Variable** button under the "Project variables" section.
    :::note
    TEST The Flag "Protect variable" is checked by default. This means that only protected branches have access to the value of the variables. It should be unchecked to allow the variable to be used in all branches.
    :::
...
1. Repeat the same process to add the _OKTETO_CONTEXT_ variables (optional)
   <p align="center">
     <Image
       src={
