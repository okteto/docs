...
1. Expand the **Variables** section, and click on the **Add Variable** button under the "Project variables" section.
    :::note
    The Flag "Protect variable" is checked by default. This means that only protected branches have access to the value of the variables. It should be unchecked to allow the variable to be used in all branches.
    :::
