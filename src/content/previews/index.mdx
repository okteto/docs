...
- **Global Scope**: The preview environment is accessible to all members of your namespace. These previews are visible to the entire team and can be managed by users with appropriate permissions. Ideal for team collaboration and stakeholder reviews.
...
:::info
The scope determines who can view and interact with the preview environment within your organization. You can set the scope when creating the preview environment.
:::
