...
- `image`: the image used by the development container. More information on development images [here](deploy/development-environments.mdx) and [dynamic value for the tag](reference/manifest.mdx#build-object-optional)
