...
<Image center src="/docs/guides/samples/images/okteto-ui.png" alt="Okteto UI ASP.NET" width="850" />
...
- `image`: the image used by the development container. More information on development images [here](reference/development-environments.mdx) and [dynamic value for the tag](reference/okteto-manifest.mdx#build-object-optional)
...
<Image center borderless src="/docs/guides/samples/images/aspnetcore-attach.png" alt="ASP.NET processes to attach to" width="850" />
...
<Image center borderless src="/docs/guides/samples/images/aspnetcore-connected.png" alt="ASP.NET connection status bar" width="850" />
...
<Image center borderless src="/docs/guides/samples/images/aspnetcore-debug.png" alt="ASP.NET core debug" width="850" />
