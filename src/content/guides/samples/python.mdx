...
<Image center src="/docs/guides/images/okteto-ui.png" alt="Okteto UI Python" width="850" />
...
<Image center src="/docs/guides/images/python-connected.png" alt="debugging with Python" width="850" />

Add a breakpoint on `app.py`, line 10. Go back to the browser and reload the page.

The execution will halt at your breakpoint. You can then inspect the request, the available variables, etc.

<Image center borderless src="/docs/guides/images/python-debug.png" alt="breakpoint in Python" width="850" />
