...
At the root of the directory, you'll find the `okteto.yaml` file. This describes how to [build](reference/manifest.mdx#build-object-optional), [deploy](reference/manifest.mdx#deploy-string-optional), and [develop](reference/manifest.mdx#develop-string-optional) the Java Sample App.
...
<Image center src="/docs/guides/samples/images/okteto-ui.png" alt="Okteto UI Java" width="850" />
...
<Image center src="/docs/guides/samples/images/java-debug.png" alt="debugging in Okteto with Java" width="850" />
...
<Image center src="/docs/guides/samples/images/java-halt.png" alt="breakpoint in Java" width="850" />
