...
<Image center src="/docs/guides/samples/images/okteto-ui.png" alt="Okteto UI PHP" width="850" />
...
<Image center src="/docs/guides/samples/images/php-halt.png" alt="debugging in Okteto with PHP" width="850" />
