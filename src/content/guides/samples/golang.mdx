...
<Image center src="/docs/guides/samples/images/okteto-ui.png" alt="Okteto UI golang" width="850" />
...
<Image center src="/docs/guides/samples/images/golang-debug.png" alt="debugging in Okteto with golang" width="850" />
