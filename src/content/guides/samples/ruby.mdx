...
[Okteto](https://example.okteto.com/#/?origin=docs) gives instant access to secure Kubernetes namespaces to enable developers to code, build, and run Kubernetes applications entirely in the cloud.
...
- Configure Access to your namespace [using the Okteto CLI](core/credentials/kubernetes-credentials.mdx#download-your-kubernetes-credentials-using-the-okteto-cli) or [using the Okteto UI](core/credentials/kubernetes-credentials.mdx#download-your-kubernetes-credentials-from-the-okteto-cloud-ui).
