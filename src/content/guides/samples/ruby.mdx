...
- Install the latest version of the Okteto CLI. Follow this [guide](core/using-okteto-cli.mdx) if you haven't done it yet.
- Configure Access to your Okteto Cloud Namespace [using the Okteto CLI](core/credentials/kubernetes-credentials.mdx#download-your-kubernetes-credentials-using-the-okteto-cli) or [using the Okteto UI](core/credentials/kubernetes-credentials.mdx#download-your-kubernetes-credentials-from-the-okteto-cloud-ui).
...
<Image center src="/docs/guides/samples/images/okteto-ui.png" alt="Okteto UI Ruby" width="850" />
...
<Image center src="/docs/guides/samples/images/ruby-halt.png" alt="debugging in Okteto with Ruby" width="850" />
