...
You can add them both as an [Admin Secret](admin/dashboard.mdx#secrets-section) (if you want everyone in your instance to be able to use them), or a [User Secret](manifest/okteto-secrets.mdx).
