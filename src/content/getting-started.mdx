...
You can launch a remote Development Environment on Okteto's [SaaS platform](https://cloud.okteto.com) or **any** Kubernetes cluster with the Okteto CLI. For this guide, we'll be using Okteto's SaaS platform. 
