...
The Okteto sub-components need access to Cloud Storage (for uploading and downloading your container images).

If you are using Let's Encrypt/Cert Manager to manage your certificates, Okteto also needs access to Cloud DNS (to fulfill the ACME challenge for the certificates).
