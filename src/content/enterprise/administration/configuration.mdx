...
Decide if you want your pods to have an affinity with the creation user: 

  - Okteto is adding to the pod a label with key "dev.okteto.com/user" and value the USER ID

  - This affinity will be used to organize the pods of the same user all together

  - This is usefull to control the node performance without afecting other users
