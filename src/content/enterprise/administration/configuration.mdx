...
The Okteto backend component configuration

- `installer`: Configuration for the pipeline installer job
  - `annotations`: Annotations to add to the backend pods.
  - `env`: Envvars to add to the backend pods.
  - `labels`: Labels to add to the backend pods.
...
- `env`: Envvars to add to the API pods.
...
- `env`: Envvars to add to the buildkit pods.
...
- `env`: Envvars to add to the daemonset pods.
...
- `env`: Envvars to add to the frontend pods.
...
- `env`: Envvars to add to the registry pods.
...
- `env`: Envvars to add to the webhook pods.
