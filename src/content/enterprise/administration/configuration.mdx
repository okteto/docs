...
When enabled, Okteto automatically adds an preferred affinity to every pod to lean towards placing pods in the same namespace in the same node (default: `true`).
