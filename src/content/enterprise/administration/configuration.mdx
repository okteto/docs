...
- `enableNamespaceAccessValidation`: Enable check of namespace to allow only members from the namespace to use the volume snapshot. Default false.
- `allowIDAnnotation`: Allow use of snapshot-id as source. Default true.
