...
Okteto needs to be able to create and delete entires on Civo's DNS service to fulfill the ACME challenge for the certificates. It will use your API key for this.
...
Download a copy of the [Okteto Civo configuration file](https://okteto.com/docs/enterprise/civo/config.yaml), open it, and update the following values:
...
See our [troubleshooting guide](/docs/enterprise/install/troubleshooting/) for tips on how to troubleshoot your Okteto instance.
