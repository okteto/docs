...
### Features
- You can now set a dedicated quota for the number of ingresses per namespace.

### Improvements
- Okteto CLI, used in pipeline installer jobs, is now version 1.15.3.
- Helm version 3.8.0 now provided in the pipeline installer jobs.
- Reloader upgraded to v0.0.104.
- Cluster SSH key is now in admin panel
- Okteto control components have now set default requests for the resources
