...
- Okteto control components have now set default requests for the resources. This will improve the reliability of the okteto control plane when a control plane and user applications are using the same pool.
