...
By default, Okteto uses Let's Encrypt to generate valid TLS servers, so your domain needs to be available over the internet.
Follow [this guide](/docs/enterprise/administration/certificates/) if you want to bring your own certificates.
...
1. Create and list DNS entries (this is needed if managing certificates with Let's Encrypt/Cert Manager).
...
With the environment set up and configuration generated, you can now proceed to the [deployment of Okteto](/docs/enterprise/install/deployment/).