...
The Okteto sub-components need access S3 (for uploading and downloading your container images).

If you are using Let's Encrypt/Cert Manager to manage your certificates, Okteto also needs access to Route 53 (to fulfill the ACME challenge for the certificates).
