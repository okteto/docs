...
The launch of [Okteto CLI 2.0](https://www.okteto.com/blog/announcing-the-launch-of-okteto-cli-2-0/) provides support for [Okteto Manifest v2](reference/okteto-manifest).

The Okteto CLI 2.0 was introduced in [Okteto 0.11.0](welcome/releases#0110). Older versions of Okteto are not able to support version 2.0 of the CLI.
