...
The Okteto CLI 2.0 was introduced in [Okteto 0.11.0](release-notes.mdx#0110). Older versions of Okteto are not able to support version 2.0 of the CLI.
...
- `okteto up`: activates your development container.
- `okteto up --deploy`: forces a redeploy of your development environment before activating your development container.
