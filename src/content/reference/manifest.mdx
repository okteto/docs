...
> Okteto will automatically add all the build environment variables from previous builds on every build as a build argument. To refer to them remember to add the `ARG` instruction on your Dockerfile.
