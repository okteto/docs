...
Remote deploy is useful to share the same tools and configuration across the team.

This will provide all the members in the team the same deployment experience since they are sharing the config and deploy tools defined in the image provided.
...
> If no image is provided the command will run in the local machine using the local tools and configuration
...
Remote destroy is useful to share the same tools and configuration across the team.

This will provide all the members in the team the same destroy experience since they are sharing the config and deploy tools defined in the image provided.
