...
> Note: This doc contains the reference for the Okteto manifest supported by OE > 0.10. For older versions, the supported manifest reference can be found [here](/docs/0.10/reference/manifest/).
