...
A list of external resources to deploy with your development environment. This external resources contains the information for resources that are deployed outside the okteto cluster.
...
Endpoints contains the information about how to access the external resource.

##### name (string, required)

The name to identify the endpoint.

##### url (string, optional)

The url to access the endpoint.

#### notes (string, optional)

A path containing a markdown document explaining what the external resource is about.
