...
The `name` of each development container matches the name of the Kubernetes deployment/statefulset that you want to put on development mode.
If the name of your deployment/statefulset is dynamicly generated, use the [selector](/docs/reference/manifest/#selector-mapstringstring-optional) field to match the deployment/statefulset by labels.
