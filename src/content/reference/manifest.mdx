...
As in [forward](#forward-string-optional) in dev section, several formats are accepted for this section.
...
As we can see in the examples, in this case we need to indicate the name of the service to be forwarded.
