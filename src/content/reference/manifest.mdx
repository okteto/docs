...
If you are planning to develop with your `docker-compose` only, you should check out our [Getting Started](using-dev-envs.mdx) guide!
...
There is an extended notation to deploy Docker compose files and [endpoints](reference/docker-compose.mdx#endpoints-object-optional) as part of your development environment:
...
> Dynamic endpoints: The url can be set during deployment stage by sharing `$OKTETO_EXTERNAL_{EXTERNAL_NAME}_ENDPOINTS_{ENDPOINT_NAME}_URL`
