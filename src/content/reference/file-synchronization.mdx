...
Set the `OKTETO_AUTOGENERATE_STIGNORE` feature flag to generate a default `.stignore` tailored to the typical use cases of your programming language when you run `okteto up`.
