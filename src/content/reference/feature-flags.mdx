...
If you set any feature flag variable as an [Admin Variable](admin/dashboard.mdx#admin-variables), the feature flag will be enable on any operation happening in the cluster.
