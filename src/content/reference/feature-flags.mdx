...
| OKTETO_DEV_PERSISTENT_VOLUME_SIZE                | Override the default [persistent volume](docs/reference/okteto-manifest.mdx#persistentvolume-object-optional) size for dev containers                                                                                                                                                                  | N/A                    |
