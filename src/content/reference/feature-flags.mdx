...
| OKTETO_RETRY_BUILDKIT_INTERVAL                   | Specifies the interval between successive checks of BuildKit's availability status.                                                                                                                                             | `5s`                   |
| OKTETO_MAX_RETRIES_FOR_BUILDKIT_TRANSIENT_ERRORS | Specifies the maximum number of retry attempts for build processes that fail due to transient (temporary) BuildKit errors.                                                                                                      | `3`                    |