...
You need to be [logged in](/docs/reference/cli/#context) to Okteto before running this command.
Only users with [admin access](/docs/administration/dashboard/) can deploy a global preview environment.
...
| _--watch       | (boolean)  | Watch the log output (default: `true`)                                            |
