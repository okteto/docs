...
- A user ID if you are currently logged in to https://okteto.example.com
...
https://okteto.example.com *                    cindy      tcp://buildkit.cloud.okteto.net:1234    registry.cloud.okteto.net
...
```console
$ okteto kubetoken <okteto_url> <namespace> # example: okteto kubetoken https://okteto.example.com cindy-lopez
```
