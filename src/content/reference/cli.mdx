...
> Note: This doc contains the reference for Okteto CLI 2.x.x supported by OE > 0.10. For older versions, the reference can be found [here](/docs/0.10/reference/cli/).
