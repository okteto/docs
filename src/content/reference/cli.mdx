...
Executed commands will be wrapped by `bash -c` unless the user specify it by flag.
...
| _--no-bash_                                 |   (bool)   | Execute commands without wrapping with bash (default to false)                                                                                                 |
