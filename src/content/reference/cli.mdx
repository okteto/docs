...
When you run `okteto namespace`, okteto will download the Kubernetes credentials for the namespace you specified, store them in your [kubeconfig file](https://kubernetes.io/docs/concepts/configuration/organize-cluster-access-kubeconfig/), and set the current context to it.
