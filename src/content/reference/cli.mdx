...
Create a namespace. By default the command will switch to the new namespace, add `--use=false` for just creating the namespace and keeping the current one active.
