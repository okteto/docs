...
You must be [logged in](reference/cli.mdx#context) to Okteto before running this command.
Only users with [admin access](self-hosted/admin/dashboard.mdx) can deploy a global preview environment.
...
More on sleeping resources [here](self-hosted/admin/cleanup.mdx/#sleeping-resources).
