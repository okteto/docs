...
Sleeps an okteto preview environment. You need to provide that preview name as an argument to the command.
...
Wakes an okteto preview environment. You need to provide that preview name as an argument to the command.
