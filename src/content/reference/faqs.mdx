...
For this reason, we recommend that you add the  Okteto CLI to your PATH, and that you run the 'okteto context' command to connect your CLI to your Okteto instance. Please refer to [our documentation](https://www.okteto.com/docs/getting-started/#installing-okteto-cli) for more information on this topic.
