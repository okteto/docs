...
For this reason, it is required to have Okteto CLI installed in your PATH and have it connected to your Okteto instance. In order to install the CLI in your path you can follow [our documentation](https://www.okteto.com/docs/getting-started/#installing-okteto-cli).
