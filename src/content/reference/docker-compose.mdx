...
If you need to configure HTTPS routes, use [endpoints](/docs/reference/compose/#endpoints-object-optional) instead of configuring an NGINX container in your Docker Compose file.
...
If you need make these ports public, you can use [endpoints](/docs/reference/compose/#endpoints-object-optional).
