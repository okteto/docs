...
:::warning
When `endpoint_mode` is set to `dnsrr`, the [divert feature](reference/okteto-manifest.mdx#divert) won't work.
:::

:::info
More info here: https://compose-spec.github.io/compose-spec/deploy.html#endpoint_mode
:::
