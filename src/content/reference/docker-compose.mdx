...
sidebar_label: Docker Compose Reference
id: compose
---
...
If [`build`](https://okteto.com/docs/reference/compose/#build-stringobject-optional) is defined, `image` is optional. Otherwise, it's required.
