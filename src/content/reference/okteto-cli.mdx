...
| _--namespace_ | (string) | The namespace to use (defaults to the current okteto namespace)                                                        |
| _--context_   | (string) | The context to use (defaults to the current okteto context)                                                            |
| _--env_       |  (list)  | Set environment variable in the development container.                                                                         |
...
| _--command_   |  (list)  | The command to execute in the development container. This overrides the command specified in the `dev` section of the manifest |
