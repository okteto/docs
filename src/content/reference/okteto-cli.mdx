...
| Options                                      | Description                  |
| :------------------------------------------- | :--------------------------- |
| <em className="no-wrap">_-d, --disable_</em> | Disables analytic collection |
...
Build and push the images defined in the `build` section of your Okteto Manifest using the [Okteto Build Service](core/build-service.mdx).
...
| <em className="no-wrap">_-n, --namespace_</em> | string   | Overwrites the current Okteto Namespace                                    | |
...
| Options                                        |   Type   | Description                                                                 | Default     |
| :--------------------------------------------- | :------: | :-------------------------------------------------------------------------- | :---------- |
| <em className="no-wrap">_--dependencies_</em>  |   bool   | Force deployment of repositories in the `dependencies` section              | `false` |
| <em className="no-wrap">_-f, --file_</em>      | string   | The path to the Okteto Manifest                                            | `okteto.yml`|
...
| <em className="no-wrap">_-t, --timeout_</em>   | duration | The duration to wait for the development environment deployment to complete. Any value should contain a corresponding time unit e.g. 1s, 2m, 3h  | 5m0s |
...
| <em className="no-wrap">_-d, --dependencies_</em>  |  bool  | Force destroy repositories in the `dependencies` section                                                                                                                                                                                                            | `false` |
| <em className="no-wrap">_-f, --file_</em>          | string | The path to the Okteto Manifest                                            | `okteto.yml`|
...
The doctor file is a handy way to collect all the information relevant for troubleshooting an issue.
Use it when filing an issue or asking [the Okteto community](http://community.okteto.com) for help.
...
| Options                                        |  Type  | Description                                                             | Default     |
| :--------------------------------------------- | :----: | :---------------------------------------------------------------------- | :---------- |
| <em className="no-wrap">_-A, --all_</em>       | bool   | Deactivate all running dev containers                                   | `false` |
| <em className="no-wrap">_-f, --file_</em>      | string | The path to the Okteto Manifest                                            | `okteto.yml`|
| <em className="no-wrap">_-n, --namespace_</em> | string | Overwrites the current Okteto Namespace                                 | |
| <em className="no-wrap">_-v, --volumes_</em>   | bool   | Remove persistent volumes where your local folder is synched on remote  | `false` |
...
List existing Okteto Namespaces.
...
| Options                                         |   Type   | Description                                                                                                                    | Default     |
| :---------------------------------------------- | :------: | :----------------------------------------------------------------------------------------------------------------------------- | :---------- |
| <em className="no-wrap">_-b, --branch_</em>     |  string  | The branch to deploy                                                                                                           | The main branch |
| <em className="no-wrap">_-f, --file_</em>       | string   | The path to the Okteto Manifest                                            | `okteto.yml`|
...
| <em className="no-wrap">_--name_</em>           |  string  | The name of the Development Environment                                     | The repo/folder name |
| <em className="no-wrap">_-n, --namespace_</em>  | string   | Overwrites the current Okteto Namespace                                    | |
| <em className="no-wrap">_-r, --repository_</em> |  string  | The HTTPS url of the repository to deploy (e.g. https://github.com/okteto/movies)                                              | |
...
| <em className="no-wrap">_-s, --scope_</em>   |  string  | The scope of Preview Environment to creat: `personal` or `global`. A personal Preview Environment can only be accessed by its creator, while in a global Preview Environment all cluster users can access it.       | `global` |
...
| Options                                   | Type | Description                                                 | Default     |
| :---------------------------------------- | :--: | :---------------------------------------------------------- | :---------- |
| <em className="no-wrap">_-w, --wait_</em> | bool | Wait until the preview destruction finishes                 | `true`      |
...
Restarts the containers corresponding to the `services` section of the Okteto Manifest for a given Development Container.
...
| Options                                        |   Type   | Description                                                                                                            | Default     |
| :--------------------------------------------- | :------: | :--------------------------------------------------------------------------------------------------------------------- | :---------- |
| <em className="no-wrap">_--deploy_</em>        |  bool    | Force execution of the commands in the `deploy` section of the okteto manifest                                         | `false` |
| <em className="no-wrap">_-f, --file_</em>      | string   | The path to the Okteto Manifest                                            | `okteto.yml`|
| <em className="no-wrap">_-n, --namespace_</em> | string   | Overwrites the current Okteto Namespace                                    | |
| <em className="no-wrap">_--name_</em>          |  string  | The name of the Development Environment                                     | The repo/folder name |
...
You can also overwrite the start [command](reference/okteto-manifest.mdx#command-string-optional) in your Development Container withh the syntax `okteto up -- COMMAND [args...]`.
...
Show information about how to updathe the Okteto CLI.
