...
In your CI/CD you should use environment variables to specify your okteto context, namespace and token. Check out [Environment Variables](/docs/core/credentials/environment-variables) to know more.
