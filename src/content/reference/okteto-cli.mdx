...
| _--file_           |  (string)  | The location of the okteto manifest. If not set, the [automatic deployment rules](development/using-okteto-cli.mdx#deployment-manifests) will be applied. |
