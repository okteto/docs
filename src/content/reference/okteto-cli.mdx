...
In your CI/CD you should use environment variables to specify your Okteto Context, Namespace and token. Check out [Environment Variables](/docs/1.20/core/credentials/environment-variables/) to know more.
