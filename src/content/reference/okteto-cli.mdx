...
:::warning
CLI 3.0 introduces some flag changes for `okteto deploy`
...
:::warning
Please note that `okteto init` will be deprecated in CLI 3.0
:::
...
:::warning
In Okteto CLI 3.0 `okteto pipeline deploy` will default to `--wait=true`
:::
...
:::warning
In Okteto CLI 3.0 `okteto pipeline destroy` will default to `--wait=true`
:::
...
:::warning
In Okteto CLI 3.0 `okteto preview deploy` will default to `--wait=true`
:::
...
:::warning
In Okteto CLI 3.0 `okteto preview destroy` will default to `--wait=true`
:::
...
:::warning
CLI 3.0 introduces some flag changes for `okteto up`:
