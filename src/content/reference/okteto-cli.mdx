...
| <em className="no-wrap">_--secret_</em>       |  list  | Secrets exposed to the build. Format: `id=mysecret,src=/local/secret` for file-based secrets or `id=mysecret,env=MY_ENV_VAR` for environment variable-based secrets | |
