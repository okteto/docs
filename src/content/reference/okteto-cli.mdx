...
- Commands labeled `Platform` are available exclusively on the Okteto platform and require the [Okteto Helm Chart to be installed](get-started/install/index.mdx#deploying-okteto) in your Kubernetes cluster
...
| Options                                         |   Type   | Description                                                                                                                    | Default     |
| :---------------------------------------------- | :------: | :----------------------------------------------------------------------------------------------------------------------------- | :---------- |
| <em className="no-wrap">_-b, --branch_</em>     |  string  | The branch to deploy                                                                                                           | Ypur current branch |
| <em className="no-wrap">_-f, --file_</em>       | string   | The path to the Okteto Manifest                                            | `okteto.yml`|
