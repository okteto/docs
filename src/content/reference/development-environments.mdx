...
A second option available is [Okteto SaaS](https://www.okteto.com/pricing/?plan=SaaS). Using Okteto SaaS, you don't have to take care of setting up the infrastructure for deployment yourself. Okteto SaaS was built keeping dev environments in mind, so it also comes with useful [additional features](index) you would not find in a traditional cluster. To know more about it, you can head over to the Okteto SaaS [documentation](index). 

Another option available is [Okteto Self-Hosted](https://www.okteto.com/pricing/). Okteto Self-Hosted gives you all the features of Okteto SaaS - on your own infrastructure. This offers you full control of your Kubernetes infrastructure while delivering the same smooth experience you expect from Okteto SaaS. The Okteto Self-Hosted [documentation](self-hosted) covers how you can get started with it.
