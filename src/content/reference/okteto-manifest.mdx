...
- `image`: the name of the image to build and push. In clusters that have Okteto installed, this is optional (if not specified, the [Okteto Registry](deploy/components/container-registry.mdx) is used).
...
Follow this document for a list of [environment variables](deploy/using-the-cli.mdx#build-environment-variables) available in your deploy commands to refer to the images built in the `build` section of your Okteto Manifest.
...
Follow this document for a list of [environment variables](deploy/using-the-cli.mdx#dependencies-environment-variables) available in your deploy commands to refer to `variables` of your `dependencies`.
...
Follow this document for a list of [environment variables](deploy/using-the-cli.mdx#built-in-environment-variables) available in your deploy commands.
...
Follow this document for a [list of variables](deploy/using-the-cli.mdx#built-in-environment-variables) available in your destroy commands.
