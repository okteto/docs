...
- `image`: the name of the image to build and push. In clusters that have Okteto installed, this is optional (if not specified, the [Okteto Registry](core/components/container-registry.mdx) is used).
...
Follow this document for a list of [environment variables](core/using-okteto-cli.mdx#build-environment-variables) available in your deploy commands to refer to the images built in the `build` section of your Okteto Manifest.
...
Follow this document for a list of [environment variables](core/using-okteto-cli.mdx#dependencies-environment-variables) available in your deploy commands to refer to `variables` of your `dependencies`.
...
Follow this document for a list of [environment variables](core/using-okteto-cli.mdx#built-in-environment-variables) available in your deploy commands.
...
Follow this document for a [list of variables](core/using-okteto-cli.mdx#built-in-environment-variables) available in your destroy commands.
...
> More information on development images [here](deploy/development-environments.mdx)
...
- `sync`: the standard and default mode. This mode will synchronize your code with the development container.
...
More information about hybrid development is [available here](manifest/hybrid-development.mdx)

#### nodeSelectodr (map[string]string, optional)
