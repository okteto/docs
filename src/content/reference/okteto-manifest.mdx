...
:::info
Okteto recommends to enable [Remote Execution](core/remote-execution.mdx) for your deploy commands
:::
...
:::info
Okteto recommends to enable [Remote Execution](core/remote-execution.mdx) for your destroy commands
:::
