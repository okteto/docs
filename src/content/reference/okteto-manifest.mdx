...
Follow this document for a list of [environment variables](reference/okteto-manifest.mdx#deploy-with-commands) available in your deploy commands to refer to the images built in the `build` section of your Okteto Manifest.
