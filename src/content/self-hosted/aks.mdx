...
This guide assumes your domain is registered in [AzureDNS](https://docs.microsoft.com/en-us/azure/dns/dns-overview).
You can use any DNS service you prefer, but this guide focuses specifically on Azure's DNS.
