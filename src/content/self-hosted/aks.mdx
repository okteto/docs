...
<<<<<<< HEAD:src/content/self-hosted/aks.mdx
> The Okteto default installation uses self-signed certificates. We strongly recommend to reconfigure Okteto to [bring your own certificates](/docs/self-hosted/administration/certificates/) next.
=======
> The Okteto default installation uses self-signed certificates. We strongly recommend you to reconfigure Okteto to [bring your own certificates](/docs/enterprise/administration/certificates/) next.
>>>>>>> Update src/content/enterprise/aks.mdx:src/content/enterprise/aks.mdx
