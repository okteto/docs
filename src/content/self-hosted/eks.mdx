...
> Okteto supports OAuth providers like Google, GitHub, or OpenID Connect to handle user authentication. For this guide, we'll focus on using GitHub. All the supported configuration settings [are described here](/docs/administration/configuration/#auth).
...
> You can also configure Okteto to assume a role instead of using access keys. Check the [AWS section in the configuration page](/docs/administration/configuration/#cloud) to learn more.
...
Follow [this document](/docs/administration/certificates/) to reconfigure Okteto with your own certificates.
