...
> **Important**: The Okteto default installation uses self-signed certificates. We strongly recommend you to reconfigure Okteto to [bring your own certificates](/docs/self-hosted/administration/certificates/) next.
