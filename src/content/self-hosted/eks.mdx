...
> Our installation guides assume Okteto will be running in a dedicated cluster. If you want to install Okteto in a cluster with other workloads, we recomment to contact support for extra guidance.
