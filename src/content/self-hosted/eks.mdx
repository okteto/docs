...
This guide assumes your domain is registered in Google's [Amazon Route53](https://aws.amazon.com/route53/) service.
You can use any DNS service you prefer, but this guide focuses specifically on Amazon's Route53.
