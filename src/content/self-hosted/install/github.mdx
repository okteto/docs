...
> You can also [use a secret](reference/helm-chart-settings.mdx/#store-sensitive-configuration-values-using-a-secret) to store the clientSecret and the appPrivateKey.
