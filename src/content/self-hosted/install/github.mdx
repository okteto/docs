...
Add the values we generated in the previous steps to your existing [Helm configuration file](get-started/quickstart-guide.mdx#configuration-file).
...
> You can also [use a secret](reference/helm-chart-values.mdx/#store-sensitive-configuration-values-using-a-secret) to store the clientSecret and the appPrivateKey.
...
> You can also use the appId and clientId values of your GitHub application in the `auth.github` section of your Helm configuration file if you're using GitHub as your [authentication provider](get-started/quickstart-guide.mdx#authentication).
...
<p align="center"><Image src="/docs/self-hosted/images/verify-installation.png" alt="verify your installation" width="650" /></p>

When you click on it, you should see the list of repositories that you added in the previous step. [This document](deploy/from-private-repositories.mdx) has further information on how to deploy a private repository.
