...
- [Install Okteto in Amazon Elastic Kubernetes Service](/docs/self-hosted/eks/)
- [Install Okteto in Azure Kubernetes Service](/docs/self-hosted/aks/)
- [Install Okteto in Civo](/docs/self-hosted/civo/)
- [Install Okteto in Google Kubernetes Engine](/docs/self-hosted/gke/)
- [Install Okteto in DigitalOcean Kubernetes](/docs/self-hosted/do/)

## Troubleshooting

We've done our best to make Okteto easy to install and operate. [The troubleshooting page](/docs/self-hosted/install/troubleshooting/) has tips and tricks to help troubleshoot common issues.
...
1. [Preparation](/docs/self-hosted/install/preparation/)
2. [Deployment](/docs/self-hosted/install/deployment/)
...
Instructions on how to upgrade your Okteto instance [are available here](/docs/self-hosted/install/upgrade/).

Please review [the release notes before upgrading](/docs/self-hosted/install/releases/). New features, known issues, and configuration changes will be listed there.
