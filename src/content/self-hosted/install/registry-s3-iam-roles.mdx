...
sidebar_label: S3 Access via IAM Roles
id: registry-s3-iam-roles
---

# Setting Up Okteto Registry with S3 Access via IAM Roles

This guide will walk you through the process of setting up Okteto Self Hosted Registry with S3 access via IAM Roles.
