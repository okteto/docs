...
More information on the different configuration settings [is available here](reference/helm-chart-settings.mdx#volumesnapshots).
...
Follow [this guide](core/components/use-volume-snapshots.mdx#using-volume-snapshots-in-your-development-environment) to use Volume Snapshots in your development environment.
