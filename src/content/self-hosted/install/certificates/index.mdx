...
If you cannot use wildcard certificates, our community maintains a guide to explain [how to install Okteto without a wildcard certificate](https://community.okteto.com/t/how-do-i-install-okteto-without-a-wildcard-certificate/796).