...
Each cloud provider offers its own mechanism to inject a CA into node trust stores:
...
- **Amazon Elastic Kubernetes Service (EKS)**, depending on how you manage nodes:
  - With Karpenter, through the node class [`spec.userData`](https://karpenter.sh/docs/concepts/nodeclasses/#specuserdata).
