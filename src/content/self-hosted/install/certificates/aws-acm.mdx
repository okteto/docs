...
We recommend configuring the following variables to help you scripting the certificate configuration:
...
Finally, [upgrade](self-hosted/manage/upgrade.mdx) your Okteto instance for the new configuration to be applied.
