...
- Fixed a regression which was preventing the deploy dialog to load automatically the list of repositories accesible in GitHub for new users when the authentication provider was GitHub.
