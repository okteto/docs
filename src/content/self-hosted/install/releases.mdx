...
- The Okteto CLI has been upgraded to version [2.19.0](https://github.com/okteto/okteto/releases/tag/2.19.0).
- The Admin view has been redesigned with a new vertical tab column. <!-- 6851 -->
- Added "Registry Credentials" to the Admin view to display configured private registry information. This provides visibility into the private registries in use for your Okteto instance (username/password and AWS Access/Secret only for now) (link to docs TBC) <!-- 6851 -->
