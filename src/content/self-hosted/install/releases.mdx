...
A valid license is now required for okteto to work. If you were running a previous version of okteto that has no license, an expired license or no license at all make sure to [reach out to us](https://www.okteto.com/contact/) to request one, [open a support ticket](https://okteto.com/support?_gl=1*1ikydzg*_ga*MTMyMjc0MTYyOS4xNjUyMjA1MjQ0*_ga_KSKZWJHTJZ*MTY5NTM5Njk3MS4yMTguMS4xNjk1Mzk3MDk3LjU2LjAuMA..) or signup for our [30 day free trial](https://www.okteto.com/free-trial/).
...
- Allow to configure kubetoken auth TTL through helm configuration (defaults to 24h)  <!-- 7142 -->
