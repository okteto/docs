...
- As of this versions deploying helm charts through the Okteto UI has been deprecated.
...
- Expose prometheus node metrics data in `/metrics`. More info [here](ADD_LINK).
- Native support for Private Registry Credentials. More info [here](ADD_LINK).
