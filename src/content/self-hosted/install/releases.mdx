...
### Breaking changes
- Default value for `.Values.buildkit.service.sessionAffinity` is now empty. For cluster updates, please refer to the latest self-hosted guide to set this value for your own installation.
