...
- The default installation of Okteto doesn't require a PVC for [BuildKit](self-hosted/administration/configuration.mdx#token). It now uses [filesystem storage](self-hosted/administration/configuration.mdx#filesystem) by default
