...
- Git Catalog feature will be part of the core of Okteto

### Bug Fix

- Use case insensitive check for GitHub ID
- GitHub redeploy modal was allowing `repo` field to be modified if opened fast enough
- Support for "resources" for the okteto daemonset
- Fix race condition that made namespaces in the Okteto UI empty  
- Fix selecting a repository in the redeploy dialog
- Fix bug in the Okteto UI for the updated time of development environments
