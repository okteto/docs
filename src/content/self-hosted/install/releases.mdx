...
### Breaking changes
- Default value for `.Values.buildkit.service.sessionAffinity` is now empty. To keep using `ClientIP` as `sessionAffinity` you need to set this at your cluster [configuration](self-hosted/administration/configuration.mdx#buildkit).
