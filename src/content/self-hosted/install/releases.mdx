...
### Features
- Allow members of a namespace shared it.

### Improvements
- Allow to disable the autoscaler.
...
- Removing ingress rules for buildkit and localhost.
...
- Enable [user pod preferred affinity](/docs/enterprise/administration/configuration/#userpodaffinity) by default- Eliminated buildkit upgrade failures related to immutable statefulset fields.
