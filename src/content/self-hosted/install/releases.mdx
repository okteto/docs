...
- Private Registry credentials defined in helm has been deprecated. Private Registry Credentials are now supported natively by Okteto and credentials defined in helm will be automatically migrated. More info [here](https://www.okteto.com/docs/self-hosted/install/upgrade/#upgrading-to-okteto-114x)
...
- Expose prometheus node metrics data in `/metrics`. More info [here](https://www.okteto.com/docs/administration/okteto-insights).
- Native support for Private Registry Credentials. More info [here](https://www.okteto.com/docs/administration/dashboard/#registry-credentials).
