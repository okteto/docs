...
- Upgrade nginx to [1.8.4](https://github.com/kubernetes/ingress-nginx/releases/tag/controller-v1.9.4) (chart 4.8.3) <!-- 7386 -->

### Bug Fixes

- Fix cli auth when using openid "audience" or "resource" attributes  <!-- 7363 -->
- Fallback to default branch for destroy installer jobs  <!-- 7382 -->
- Add scrollbar to space selector in the UI  <!-- 7355 -->
...
- Istio's Virtual Service now show only their own dedicated endpoints when using ["dev.okteto.com/endpoints" annotation](cloud/ssl.mdx#customizing-the-endpoints-shown-in-the-okteto-ui). <!-- 6822 -->
