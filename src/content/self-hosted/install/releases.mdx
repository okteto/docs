...
- Pipeline installation now use dynamic kubernetes token to talk to the kubernetes api via the [ClientAuthentication API](https://kubernetes.io/docs/reference/config-api/client-authentication.v1/).
