...
- Updated the `crd` configuration in the Helm chart to follow recommended practices for [CRD management](/docs/reference/manifest/#crds)
- You can now define [custom affinities](/docs/reference/manifest/#affinity) for dev containers and installer jobs in helm config
...
- You can now override the images of the [daemon](/docs/reference/manifest/daemonset) and  [autoscaler](/docs/reference/manifest/autoscaler) using the Helm configuration file
