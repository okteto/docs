...
- Now you can select an expiration period when creating a new [Personal Access Token](docs/cloud/personal-access-tokens/#creating-a-personal-access-token). <!-- 6690 -->
