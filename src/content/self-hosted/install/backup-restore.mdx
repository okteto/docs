...
- **Okteto Metadata recovery process**: recovers all the users’ metadata, tokens, secrets and custom resources. It doesn’t recover users’ namespaces, preview environments and volumes.
