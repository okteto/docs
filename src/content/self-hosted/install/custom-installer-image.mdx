...
To enable the custom image, update your `config.yaml` file with the following values, and run a [helm upgrade](self-hosted/manage/upgrade.mdx) to apply the new configuration.
