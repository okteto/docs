...
If you don't use `privateRegistry` key, you can just upgrade Okteto as any other release. If you use it, we recommend you the following steps to upgrade your instance to `1.14.x` or higher:
...
If you miss any registry or they weren't migrated at all, you can check the logs of a job called xxxx to see the root cause. You can also contact us to xxxxxx.
