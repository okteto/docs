...
- Verify that credentials were successfully migrated. You can do that going to [Registry Credentials](administration/dashboard.mdx/#registry-credentials) section with Admin Dashboard and checking that all credentials are there.
