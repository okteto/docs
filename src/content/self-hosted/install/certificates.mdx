...
By default, Okteto will create a self-signed wildcard certificate for your cluster. This certificate is used to secure communication to the Okteto UI, the build service, the registry service, and to all the applications that use [Automatic SSL Endpoints](/core/ingress/automatic-ssl).
