...
> If you are planning on using our GitHub Integration for accessing private repositories, you should follow [the guide to configure our GitHub App](self-hosted/install/private-repositories/github.mdx).
