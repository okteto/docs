---
title: Use OpenID Connect as your Authentication Provider
description: Use OpenID Connect as the authentication provider of your Okteto Self-hosted instance
