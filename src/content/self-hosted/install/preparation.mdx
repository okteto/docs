...
By default, Okteto creates a self-signed certificate to secure communication to the Okteto UI, the build service, the registry service, and to all the applications that use  [Automatic SSL Endpoints](https://okteto.com/docs/cloud/ssl/).
