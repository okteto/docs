...
1. Start a port-forward to the ingress service by running:
   ...
   $ kubectl port-forward service/okteto-ingress-nginx-controller 8443:443 --namespace okteto

2. Access your Okteto instance at https://okteto.localtest.me:8443/login#token=******
...
2. Configure the Okteto CLI context:
   ...
   $ okteto context use https://okteto.localtest.me:8443 --token ******
