...
:::tip
Configure at least 2 nodes for the BuildKit node pool, each one on a different zone, for high availability.
:::
...
Even the best BuildKit setup cannot compensate for un-optimized Dockerfiles...
