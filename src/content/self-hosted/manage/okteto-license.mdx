...
:::note
You can also optionally include your Okteto license using [Cloud Secrets](/reference/helm-chart-values.mdx#cloud-provider-secret).
:::
...
After that, you'll need to [upgrade your instance](src/content/self-hosted/manage/upgrade.mdx#upgrade-okteto) for the new license to be applied. 