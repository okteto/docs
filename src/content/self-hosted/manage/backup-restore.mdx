...
- **Okteto Metadata recovery process**: recovers all the users’ metadata, tokens, variables, secrets, and custom resources mentioned [in the section above](self-hosted/manage/backup-restore.mdx#okteto-metadata). It doesn’t recover users’ namespaces, preview environments and volumes.
