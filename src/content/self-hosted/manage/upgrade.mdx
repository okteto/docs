...
In the Okteto [1.20 release](release-notes.mdx#1200), we have enabled [Pull Secrets by default](admin/registry-credentials/index.mdx#pull-secrets-vs-kubelet-reconfiguration). If you do no wish to manage Pull Secrets the following helm values should be disabled:
