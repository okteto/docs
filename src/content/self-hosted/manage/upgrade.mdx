...
- **Internal Certificate Unification**: Internal certificates have been unified into a single configuration. During the upgrade, you may experience temporary communication issues lasting a few seconds as the new certificate configuration takes effect. This is expected behavior and should resolve automatically.
- **ArgoCD Installations**: If you manage your Okteto installation with ArgoCD, ensure you review the helm configuration changes for this release. The certificate unification may require special attention during the ArgoCD sync process to avoid deployment interruptions.
