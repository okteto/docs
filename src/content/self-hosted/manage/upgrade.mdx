...
- Verify that credentials were successfully migrated. You can do that going to [Registry Credentials](self-hosted/admin/dashboard.mdx/#registry-credentials) section within Admin Dashboard and checking that all credentials are there.
...
If you are [bringing your own certificates](self-hosted/install/certificates.mdx), your Okteto instance is now fully upgraded. The rest of the guide doesn't apply to your configuration.
...
```
helm install cert-manager jetstack/cert-manager --namespace=okteto --version=v1.10.2
```
