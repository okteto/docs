...
Once the upgrade has been completed, go to your instance and click on the **Log In** button to access your instance using Azure Active Directory as the authentication provider.
