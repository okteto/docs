...
<p align="center"><Image src={require('@site/static/img/new-app.png').default} alt="Create the new app" /></p>
...
<p align="center"><Image src={require('@site/static/img/new-web-app-integration.png').default} alt="Create the new app integration" /></p>

<p align="center"><Image src={require('@site/static/img/new-web-app-integration-2.png').default} alt="Create the new app integration" /></p>
...
<p align="center"><Image src={require('@site/static/img/secrets-sidebar.png').default} alt="Copy the client ID and the Client Secret" /></p>

Assign the users or groups that will have access to Okteto to the application that you just created.

<p align="center"><Image src={require('@site/static/img/assignment.png').default} alt="Assign the users to the application" /></p>
...
<p align="center"><Image src={require('@site/static/img/well-known.png').default} alt="Get the URLs for authorization" /></p>
...
<p align="center"><Image src={require('@site/static/img/profile.png').default} alt="Update the profile in the application assignment" /></p>

<p align="center"><Image src={require('@site/static/img/profile-details.png').default} alt="Update the profile details in the application assignment" /></p>
...
<p align="center"><Image src={require('@site/static/img/with-okta.png').default} alt="Log in with Okta" /></p>
...
<p align="center"><Image src={require('@site/static/img/add-user.png').default} alt="Add user to the Okta application" /></p>