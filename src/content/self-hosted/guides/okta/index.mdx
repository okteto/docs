...
> You can also store the value of clientSecret [as a secret directly in Kubernetes](reference/helm-chart-settings.mdx/#store-sensitive-configuration-values-using-a-secret).

Then, [upgrade your installation](self-hosted/manage/upgrade.mdx) to apply the changes. We recommend that you upgrade to the same version that you already have to minimize the changes and help with your troubleshooting.
