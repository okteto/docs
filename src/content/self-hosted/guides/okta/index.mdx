...
By default, Okteto will use the attributes below when creating a user. These will be synchronized when the account is created, and everytime the user logs in. 
...
> If you want to sync the profile picture from Okta, you'll need to set the Picture URL” property of the user profile in the Application Assignment.
