...
:::info
This guide will use https://gitlab.com in the examples. If you're using GitLab self-hosted, replace gitlab.com with your instances URL.
:::
...
- Name: "okteto"
- Redirect URI: "https://okteto.${YOUR_DOMAIN}.com" 
- Scopes:
  - openid  
  - profile
  - email 
