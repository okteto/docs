...
You'll need sufficient access to a [subdomain](et-started/configure/configuration-settings/#subdomain) to add a wildcard DNS record, such as dev.example.com.
