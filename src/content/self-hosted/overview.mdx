...
Connect with Okteto users and experts for tips, tricks, and solutions in our [Community Forum](https://community.okteto.com).
...
You can also [reach out to our support team](https://okteto.com/support) if you need additional assistance.
...
1. [Preparation](get-started/overview.mdx)
