...
- Keep your infrastructure under control with the Okteto [Garbage Collector](self-hosted/admin/cleanup.mdx) and the [Okteto Autoscaler](reference/helm-chart-values.mdx#autoscaler)
