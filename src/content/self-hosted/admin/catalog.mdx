...
<p align="center"><Image src="/docs/self-hosted/images/gc_add_repo_sidebar.png" alt="add a repository to the Catalog" width="900" /></p>
...
<p align="center"><Image src="/docs/self-hosted/images/gc_add_env_vars.png" alt="add environment variables to Catalog repo" width="800" /></p>
...
In this section you should see all of the repositories you’ve added (and pre-configured). Select an entry you wish to use and click `Launch`.

<p align="center"><Image src="/docs/self-hosted/images/gc_launch_dev_env.png" alt="launch a development environment from the Catalog" width="600" /></p>

<p align="center"><Image src="/docs/self-hosted/images/gc_view_env_vars.png" alt="view a Catalog repo's environment variables" width="600" /></p>
