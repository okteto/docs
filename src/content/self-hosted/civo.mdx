...
This guide assumes your domain is registered in [Civo](https://www.civo.com/account/dns).
You can use any DNS service you prefer, but this guide focuses specifically on Civo's DNS.
