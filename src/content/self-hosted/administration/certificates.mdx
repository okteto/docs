...
If [`publicOverride`](self-hosted/administration/configuration.mdx#publicoverride) is set, its value must also be included in the certificate `Subject Alternative Name` list.
