...
Okteto supports using Bitbucket, GitHub, Google, OpenID Connect, or Token-based as authentication providers.
...
Token-based is the default authentication method.
This method permits users to validate their identity by employing a randomly generated token comprising eight characters.
The token-based authentication approach is an optimal choice for testing/evaluation scenarios, where access to Okteto is restricted to a single user. This is not recommended for multiple users or production setups.
