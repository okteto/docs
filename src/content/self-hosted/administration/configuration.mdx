...
- `priorityClassName`: The priority class to be used by gc pods.
...
- `priorityClassName`: The priority class for pods created by the installer jobs.
...
- `enabled`: Enables this feature. Defaults to `false`
- `schedule`: Cron schedule to run the job. Defaults to `*/1 * * * *`.
- `components`: `app.kubernetes.io/component` label values of daemonset to check. Defaults to `["daemon"]`
- `priorityClassName`: The priority class to be used by pods of this component.
