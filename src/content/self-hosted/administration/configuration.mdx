...
- `ingress`: Incoming list of rules ([networking ingress](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#networkpolicyingressrule-v1-networking-k8s-io)) to be applied to the selected pods. (optional).
- `egress`: Outgoing list of rules ([networking egress](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#networkpolicyegressrule-v1-networking-k8s-io)) to be applied to the selected pods (optional).
