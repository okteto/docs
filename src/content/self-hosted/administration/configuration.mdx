...
- `resources`: The resources for the installer job pods.
...
Configures the the Okteto custom resource definition installation.
...
- `install`: Install and upgrade CRDs (defaults to `true`).
