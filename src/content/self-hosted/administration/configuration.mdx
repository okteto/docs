...
- `image`: The image to use for the autoscaler. It defaults to `busybox`.
...
- `initContainers.privateCA.image`: Image of the init container used for the private CA. Defaults to `busybox`
