...
- `ingress`: Incoming list of rules to be applied to the selected pods. (optional) [networking ingress](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#networkpolicyingressrule-v1-networking-k8s-io)
- `egress`: Outgoing list of rules to be applied to the selected pods (optional) [networking egress](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.22/#networkpolicyegressrule-v1-networking-k8s-io)
