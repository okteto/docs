...
The token-based authentication method is the default authentication method.
It allows users to authenticate themselves using a random token of 8 characters.
This method is suitable for testing scenarios where only one user needs to access Okteto.
