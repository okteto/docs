...
Okteto supports any identity provider that implements the OpenID Connect standard.
The following external identity providers have been tested with Okteto:

- [Okta](/docs/self-hosted/guides/okta)
- [Azure Active Directory](/docs/self-hosted/guides/azure-active-directory)

> Missing your identity provider? Open a feature request in the [Okteto Community](https://community.okteto.com/t/about-the-feature-requests-category/28)!
