...
Decide if you want [pod security policy](https://kubernetes.io/docs/concepts/security/pod-security-policy/) to be added to the Roles and ClusterRoles
Enabled by default.

- `useAppArmor`: Add the apparmor security annotations to the restrictive PSP
  Enabled by default.
