...
> If you've already configured GitHub OAuth, you should skip these 2 steps. You'll then use the same Github Application for the Integration as the one from Oauth.
...
Add the values we generated in the previous steps to your existing [Helm configuration file](/docs/self-hosted/install/deployment/#configuration-file).
...
> You can also use the appId and clientId values of your GitHub application in the `auth.github` section of your Helm configuration file if you're using GitHub as your [authentication provider](/docs/self-hosted/install/deployment/#authentication).
