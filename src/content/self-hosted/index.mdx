...
- [**Complete the installation**](self-hosted/install/certificates.mdx) - Includes guides for deploying Okteto through ArgoCD, setting up your own certificates, GitHub integration, and more
