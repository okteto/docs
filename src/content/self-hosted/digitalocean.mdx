...
This guide assumes your domain is registered in Google's [DigitalOcean](https://cloud.digitalocean.com/networking/domains).
You can use any DNS service you prefer, but this guide focuses specifically on DigitalOcean's Domains.
