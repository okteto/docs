...
Use this section to configure Redis for the [Resource Manager](admin/resource-manager.mdx). Redis is only isntalled if the Resource Manager is enabled.
...
- `port`: Specifies the port on which the Redis listens. The default value is `6379`.
