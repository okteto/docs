...
Configure the internal certificate created by Okteto for internal communication.
This certificate is used by `MutatingWebhookConfiguration`, `MutatingWebhookConfiguration` and `ApiService` objects created by Okteto.
