...
- `nameOverride`: String to override the full name of the defaultBackend service. If you rename an existing service, you need to follow [this manual migration steps](self-hosted/helm-configuration.mdx#manual-migration-steps-when-renaming-the-defaultbackend-service).
...
<a class="anchor anchorWithStickyNavbar_node_modules-@docusaurus-theme-classic-lib-theme-Heading-styles-module" id="manual-migration-steps-when-renaming-the-defaultbackend-service"></a>**Manual migration steps when renaming the defaultBackend service**
...
2. Upgrade the Okteto Helm chart. This will create a new `defaultBackend` service with the new name.
3. You can now safely delete the old `defaultBackend` service.
