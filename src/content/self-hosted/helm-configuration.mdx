...
- [Bitbucket](self-hosted/helm-configuration.mdx#bitbucket)
- [GitHub](self-hosted/helm-configuration.mdx#github)
- [Google](self-hosted/helm-configuration.mdx#google)
- [OpenID Connect](self-hosted/helm-configuration.mdx#openid-connect)
- [Token-based](self-hosted/helm-configuration.mdx#token)
