...
The backend service in Okteto handles the core functionalities of your application.

- `image`: Specifies the image settings for your backend service.
  - `registry`: The registry where the backend image is hosted. Defaults to `` (You can change all the registries by setting `globals.registry` to your registry).
  - `repository`: The repository path for the backend image. Defaults to `okteto/backend` if not specified.
...
- `image`: Specifies the image settings for your buildkit service.
  - `registry`: The registry where the buildkit image is hosted. Defaults to `` (You can change all the registries by setting `globals.registry` to your registry).
  - `repository`: The repository path for the buildkit image. Defaults to `okteto/buildkit` if not specified.
  - `tag`: The image tag to deploy. Defaults to `{variables.chartVersion}` if not specified.
...
- `rootless`: Specifies if the buildkit should be run rootless.
  - `image`: Specifies the image settings for your buildkit service.
    - `registry`: The registry where the buildkit image is hosted. Defaults to `` (You can change all the registries by setting `globals.registry` to your registry).
    - `repository`: The repository path for the buildkit image. Defaults to `okteto/buildkit` if not specified.
    - `tag`: The image tag to deploy. Defaults to `{variables.chartVersion}-rootless` if not specified.
...
- `persistence.cacheRatio`: What percentage the persitence size should be use for the cache. Value should be between 0 and 1. Defaults to `0.5`.
...
The cli that will be used for performing tasks like starting synchronisation service, run inside your pipeline jobs, etc.

- `image`: Container image used by the cli operation.
  - `registry`: The registry where the cli image is hosted. Defaults to `` (You can change all the registries by setting `globals.registry` to your registry).
  - `repository`: The repository path for the cli image. Defaults to `okteto/okteto` if not specified.
...
- `image`: Container image used by the daemonset pods.
  - `registry`: The registry where the daemonset image is hosted. Defaults to `` (You can change all the registries by setting `globals.registry` to your registry).
  - `repository`: The repository path for the daemonset image. Defaults to `okteto/daemon` if not specified.
  - `tag`: The image tag to deploy. Defaults to `{variables.chartVersion}` if not specified.
...
- `image`: Configuration block to customize the image used by the defaultBackend pods.
  - `registry`: registry for the defaultBackend pods (You can change all the registries by setting `globals.registry` to your registry)
  - `repository`: Repository for the defaultBackend pods. Defaults to `okteto/backend`.
  - `tag`: Tag used for the defaultBackend pods. Defaults to `{variables.chartVersion}`
...
- `image`: Configuration block to customize the image used by the frontend pods.
  - `registry`: registry for the frontend pods (You can change all the registries by setting `globals.registry` to your registry)
  - `repository`: Repository for the frontend pods. Defaults to `okteto/frontend`
  - `tag`: Tag used for the frontend pods. Defaults to `{variables.chartVersion}`
...
- `runner`: Specifies the image settings for your installer jobs.
  - `registry`: The registry where the installer image is hosted. Defaults to `` (You can change all the registries by setting `globals.registry` to your registry).
...
- `image`: Specifies the image settings for your registry service.
  - `registry`: The registry where the registry image is hosted. Defaults to `` (You can change all the registries by setting `globals.registry` to your registry).
  - `repository`: The repository path for the registry image. Defaults to `okteto/registry` if not specified.
  - `tag`: The image tag to deploy. Defaults to `{variables.chartVersion}` if not specified.
