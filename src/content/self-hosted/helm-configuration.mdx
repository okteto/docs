...
- `securityContext`: The security context for the installer job container. It's not set by default, and it follow the [same syntax used in Kubernetes](https://kubernetes.io/docs/tasks/configure-pod-container/security-context/)
