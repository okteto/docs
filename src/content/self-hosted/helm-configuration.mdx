...
- `persistence.cacheRadio`: What percentage the persitence size should be use for the cache. Value should be between 0 and 1. Defaults to `0.9`.
...
The Garbage Collector service can also be [configured in the Admin Dashboard](admin/cleanup.mdx) by navigating to Admin -> Garbage Collector.
