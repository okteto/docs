...
- `image`: Specifies the image settings for your backend service.
  ...
  - `tag`: The image tag to deploy. Defaults to `latest` if not specified.
...
- `image`: Specifies the image settings for your buildkit service.
  ...
  - `tag`: The image tag to deploy. Defaults to `0.17.2-okteto1` if not specified.
...
- `image`: Container image used by the daemonset pods.
  ...
  - `tag`: The image tag to deploy. Defaults to `0.14.0` if not specified.
...
- `image`: Configuration block to customize the image used by the defaultBackend pods.
  ...
  - `tag`: Tag used for the defaultBackend pods. Defaults to `latest`
...
- `image`: Configuration block to customize the image used by the frontend pods.
  ...
  - `tag`: Tag used for the frontend pods. Defaults to `latest`
...
- `image`: Specifies the image settings for your frontend service.
  - `registry`: The registry where the frontend image is hosted. Defaults to `` (You can change all the registries by setting `globals.registry` to your registry).
  - `repository`: The repository path for the frontend image. Defaults to `okteto/frontend` if not specified.
  - `tag`: The image tag to deploy. Defaults to `latest` if not specified.
...
- `image`: Specifies the image settings for your registry service.
  ...
  - `tag`: The image tag to deploy. Defaults to `c969a02` if not specified.
