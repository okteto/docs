...
We recommend that you follow Azure's [cluster creation guide](https://docs.microsoft.com/en-us/azure/aks/kubernetes-walkthrough) and check our [preparation guide](get-started/install/prerequisites.mdx#deploy-a-kubernetes-cluster).
