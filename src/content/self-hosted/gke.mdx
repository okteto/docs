...
This guide assumes your domain is registered in Google's [Cloud DNS](https://cloud.google.com/dns) service.
You can use any DNS service you prefer, but this guide focuses specifically on Google's Cloud DNS.
