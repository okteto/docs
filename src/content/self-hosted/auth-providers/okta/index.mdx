...
<p align="center"><Image src="/docs/self-hosted/guides/okta/images/secrets-sidebar.png" alt="Copy the client ID and the Client Secret" /></p>
...
> You can also store the value of clientSecret [as a secret directly in Kubernetes](get-started/configure/configuration-settings.mdx#store-sensitive-configuration-values-using-a-secret).

Then, [upgrade your installation](get-started/install/upgrade-okteto-instance.mdx) to apply the changes. We recommend that you upgrade to the same version that you already have to minimize the changes and help you troubleshoot any issues.
