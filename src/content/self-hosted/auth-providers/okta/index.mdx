...
> You can also store the value of clientSecret [as a secret directly in Kubernetes](get-started/configure/configuration-settings/#store-sensitive-configuration-values-using-a-secret).

Then, [upgrade your installation](get-started/install/upgrade-okteto-instance) to apply the changes. We recommend that you upgrade to the same version that you already have to minimize the changes and help you troubleshoot any issues.
