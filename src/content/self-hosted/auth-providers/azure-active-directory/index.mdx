...
Then, [upgrade your installation](get-started/install/upgrade-oktet-instance) to apply the changes. We recommend that you upgrade to the same version that you already have to minimize the changes and help you troubleshoot any issues.
