---
title: Custom Domains for your Applications
...
1. Update your DNS configuration so your custom domain points to the [Okteto subdomain](deploy/custom-domains#configure-your-dns).
...
2. Update your DNS configuration so your custom domain points to the [Okteto subdomain](deploy/custom-domains#configure-your-dns).
...
If you're using Okteto's [auto-ingress](deploy/automatic-ssl) or [generate the host](deploy/automatic-ssl#let-okteto-generate-the-host) features, then there's nothing to change. Just redeploy your application, and it will automatically pick up your custom domain.
