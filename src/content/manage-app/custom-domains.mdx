...
1. Update your DNS configuration so your custom domain points to the [Okteto subdomain](#configure-your-dns).
...
If you're using Okteto's [auto-ingress](manage-app/automatic-ssl.mdx) or [generate the host](manage-app/automatic-ssl.mdx#let-okteto-generate-the-host) features, then there's nothing to change. Just redeploy your application, and it will automatically pick up your custom domain.
