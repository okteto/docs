...
[Docker Compose](reference/docker-compose) are for developers who don't want to deal with the complexities of Kubernetes manifests.
...
- Install the Okteto CLI. Follow this [guide](deploy/using-the-cli) if you haven't done it yet.
- Configure Access to your Okteto Namespace [using the Okteto CLI](deploy/components/kubernetes-credentials/#download-your-kubernetes-credentials-using-the-okteto-cli) or [using the Okteto dashboard](deploy/components/kubernetes-credentials/#download-your-kubernetes-credentials-from-the-okteto-cloud-ui).
...
Read the docs for the [Docker Compose](reference/docker-compose) and the [available Okteto CLI commands](reference/okteto-cli) to learn more about developing your Docker Compose application on Okteto.
