...
- Install the Okteto CLI. Follow this [guide](development/using-okteto-cli.mdx) if you haven't done it yet.
...
Head over to [our getting started guides](development/containers/index.mdx) to see how to configure Okteto to live-update your application with different programming languages and **debuggers**.
