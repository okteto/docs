...
- The first command builds the Docker image of the Hello World application and pushes the image to the [Okteto Registry](deploy/components/container-registry.mdx).
