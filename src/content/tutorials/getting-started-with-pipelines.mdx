...
This tutorial provides a step by step guide to configure an [Okteto Pipeline](deploy/okteto-pipeline).
...
- The first command builds the Docker image of the Hello World application and pushes the image to the [Okteto Registry](deploy/components/container-registry).
...
Read the Okteto Pipeline [documentation](deploy/okteto-pipeline) to learn more about the Okteto Pipeline yaml syntax, available tools, and environment variables that you can use as part of your Okteto Pipeline.
