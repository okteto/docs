...
Note for `Admins`: We strongly recommend configuring external resource variables in [Variables in the Admin dashboard](admin/dashboard.mdx#variables) to centralize and manage them securely.
