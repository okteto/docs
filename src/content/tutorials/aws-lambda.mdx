...
Commit the Okteto manifest created in the previous step to your repository, and push the changes to a remote branch. Then, deploy your Development Environment [directly from the Okteto UI](deploy/deploy-from-git.mdx).
