...
Then [add a `build` section](reference/manifest.mdx#build-object-optional) to your Okteto manifest to tell Okteto to build the image on demand when deploying your development environment:
