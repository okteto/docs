...
``` 
FROM okteto/pipelFROM okteto/pipeline-runner:1.0.0 
...
[Follow this document](/docs/enterprise/configuration/custom-installer-image) to update the configuration of your Okteto instance.
...
After a few seconds, your Development Environment will be fully deployed and your AWS Lambda function will be up and running. 

The source code for this tutorial [is available here](https://github.com/okteto/aws-lambda).
