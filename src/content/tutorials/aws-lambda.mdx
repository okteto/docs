...
You can add them both as an [Admin Secret](manage-okteto/admin-dashboard/#secrets-section) (if you want everyone in your instance to be able to use them), or a [User Secret](deploy/manifest/secrets.mdx).
