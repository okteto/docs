...
You can add them as [User Variables](core/okteto-variables.mdx), or [Admin Variables](admin/dashboard.mdx#variables) if you want everyone in your Okteto instance to be able to use them.
...
Commit the Okteto manifest that we created in the previous step to your repository, and push the changes to a remote branch. Then, deploy your Development Environment [directly from the Okteto UI](development/deploy/deploy-from-git.mdx).
