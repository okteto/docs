...
[Install]((/docs/getting-started/installation/)) the Okteto CLI and configure access to Okteto Cloud:
...
## Step 6: Create your Development Container

Building and deploying your application for each code change can be tedious.
In order to do that, you can configure how to live update your application while you are coding defining a development container.
...
The full reference for development containers is [here](/docs/reference/manifest/#dev-object-optional).
...
## Step 7: Develop directly on Okteto Cloud
