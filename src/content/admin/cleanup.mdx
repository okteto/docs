...
The following events are considered activity that will prevent an application or resource from being marked as inactive or will wake a sleeping namespace:
...
Service accounts, config maps, secrets, or volumes you create will be unaffected by this operation. Additionally, if you are using the Okteto Nginx Ingress Controller, incoming requests will automatically wake a sleeping namespace.
