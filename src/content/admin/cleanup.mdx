...
By default, [Personal Namespaces](core/namespaces.mdx#personal-namespaces) (automatically created when a user logs in) were previously excluded from Garbage Collection.
...
**Completely Remove:**
- The entire Namespace and everything inside it will be deleted. For [Personal Namespaces](core/namespaces.mdx#personal-namespaces), only the resources inside the Namespace (except PVCs) are deleted—the Namespace itself remains.
