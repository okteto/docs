...
<p align="center">
  <Image
    ...
    alt="Add Credential dialog with fields for type, hostname, username, and password"
    width="500"
  />
</p>
...
<p align="center">
  <Image
    ...
    alt="Edit Credential dialog for an AWS IAM User registry with partially masked secret fields"
    width="700"
  />
</p>
