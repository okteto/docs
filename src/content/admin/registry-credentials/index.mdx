...
<p align="center">
  <Image
    src={require("./img/registry_credentials_view-v1.22+.png").default}
...
<p align="center">
  <Image
    src={require("./img/registry_credentials_add-v1.22+.png").default}
...
<p align="center">
  <Image
    src={require("./img/registry_credentials_edit-v1.22+.png").default}
