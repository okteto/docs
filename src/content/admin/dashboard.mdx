...
If you choose to use your own registry service instead of [Okteto's Container Registry](core/container-registry.mdx), you can configure credentials for that service here.

[Review this page for a full description of how to configure and start using your own Registry Credentials →](admin/registry-credentials/registry-credentials.mdx)
