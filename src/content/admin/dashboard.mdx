...
<p align="left">
  <Image
    src={require("@site/static/img/admin_dashboard_sidebar+1.25.png").default}
...
- Git SSH key
- [Okteto Insights](core/okteto-insights.mdx) token
...
:::
  ...
  <Image
    src={require("@site/static/img/admin_access_tokens+1.25.png").default}
