...
1. If the Resource Manager is enabled, you see "Manual" and "Automatic" radio buttons
1. Select "Automatic" to activate the Resource Manager's automated resource management
  ...
  <Image
    ...
    alt="Resource Manager settings in the Admin Dashboard with the Automatic option selected and CPU and memory usage charts"
    width="850"
  />
...
- Selecting "Manual" in the Admin Dashboard to disable the Resource Managers automatic adjustments
