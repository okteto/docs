...
Resource Manager has been installed in Okteto chart version 1.26 and above. Refer to our [Helm configuration documentation](self-hosted/helm-configuration.mdx#resourcemanager) for available options.
