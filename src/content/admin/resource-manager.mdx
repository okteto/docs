...
You can enable the Resource Manager through the Helm chart configuration. Refer to our [Helm configuration documentation](self-hosted/helm-configuration.mdx#resourcemanager) for available options.

#### To enable the Resource Manager:

1. Update and deploy your [Helm chart with the Resource Manager configuration](self-hosted/helm-configuration.mdx#resourcemanager)
...
1. If the Resource Manager is installed but not yet enabled, you will see an "Manual/Automatic" toggle switch
