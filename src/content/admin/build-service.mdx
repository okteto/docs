...
- **Ready**: The pod is healthy and below all recommended thresholds (50% CPU pressure, 70% Memory usage, 30% IO pressure).
- **Busy**: One or more metrics exceed the recommended thresholds (50% CPU pressure, 70% Memory usage, 30% IO pressure).
