...
- **When to adjust**: Increase if builds queue when CPU usage is acceptable. Decrease if you notice build performance degradation at current levels.
...
- **Ready**: The pod is healthy and within all recommended thresholds.
