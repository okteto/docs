...
- **Personal Scope**: The preview environment is only accessible to the owner. These previews are indicated with a user icon next to the preview name in the preview list and are private to that account.
