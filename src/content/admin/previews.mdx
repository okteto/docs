...
- **Keep Awake** - Toggle to mark a preview as persistent, preventing it from automatically sleeping due to inactivity. Because the preview remains active, it also prevents automatic deletion by the garbage collector.

:::tip
Marking a preview as persistent with "Keep Awake" prevents automatic sleeping and deletion. The preview will remain available at all times until manually deleted. This is useful for long-running demos or environments that need to be always accessible.
:::
