...
:::note
The Previews dashboard doesn't include a Scope column. Only personal-scope previews are marked, with a user icon next to the preview name. A preview with no icon has global scope, which is the default.
:::
...
- **Wake Up** - Wake up a sleeping Preview Environment to make it active again
- **Put To Sleep** - Put an active Preview Environment to sleep to save resources. This option is disabled for previews marked as "Persistent"
