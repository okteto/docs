...
<p align="center">
  <Image
    src={require("@site/static/img/cloud_credentials_view+1.27.png").default}
...
:::note
If you see a “Read-only” tag next to Cloud Credentials in the interface, it means that these items were defined using Custom Resource Definitions (CRDs). Such items cannot be modified through the Admin Dashboard.
To make changes, you will need to [update the associated CRD directly](self-hosted/manage/crds.mdx#cloud-credentials).
:::
