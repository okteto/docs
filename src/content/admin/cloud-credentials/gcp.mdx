...
description: Configure Google Cloud credentials for your Okteto instance using Workload Identity Federation to grant development environments access to GCP resources.
...
To do this, Okteto provides the OIDC endpoint of your cluster, which you can find under the Integrations -> General section of your Okteto Admin Dashboard.
