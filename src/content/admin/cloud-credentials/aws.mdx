...
- ** <OIDC_ISSUER> **: The OIDC Issuer of your Okteto instance, without the "https://" part of the url. 
- ** <OIDC_SUBJECT> **: The OIDC subject of your Okteto instance.
- ** <AUDIENCE> **: The audience that we defined in Step 1.
- ** <PROVIDER_ARN> **: The ARN of the OpenID connect provider we created in Step 1. 
