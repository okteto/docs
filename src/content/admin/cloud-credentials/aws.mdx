...
Store these values as environment variables, you will use them in the next steps (please note that you need to remove the `https://` part of the OIDC endpoint).

```bash
export OIDC_ENDPOINT=container.googleapis.com/v1/projects/myProject/locations/us-central1/clusters/myCluster
