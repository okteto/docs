...
<Image
  src={require("@site/static/img/okta-user-deprovision-dashboard+1.32.png").default}
  alt="Okta User Deprovision webhook verification"
    width="800"
/>

To configure deprovisioning in Okteto:
1. Navigate to **Admin → Integrations → General** in the Okteto Admin Dashboard and locate the Okta deprovisioning settings
