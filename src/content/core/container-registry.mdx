...
The final image name depends on the Okteto Registry URL, your current namespace, the name of your git repository and the name of your image in the Okteto Manifest.
