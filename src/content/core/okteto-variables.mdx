...
In this example, we show how `$OKTETO_ENV` can be used to configure dynamic endpoints for [External Resources](/docs/core/okteto-manifest/#external) within your dev environment.
