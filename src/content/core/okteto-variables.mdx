...
### Runtime Environment Variables (Injected into Pods)

Okteto automatically injects the following environment variables into every pod managed by Okteto at runtime. These variables are available within your application containers:
...
- **`OKTETO_MANAGED_POD`**: Set to `true` for all pods managed by Okteto. Useful for identifying and filtering Okteto-managed pods.

### Deployment Environment Variables

The following environment variables are automatically injected by Okteto during deployment operations. You can use them in the manifest and `deploy`, `destroy` and `test` sections, including your scripts and tools (e.g. `Makefile`).
...
<p align="center">
  <Image
    ...
    alt="Settings page with the Variables tab selected, showing a user variable with a masked value and a Remove button"
    width="650"
  />
</p>
...
<p align="center">
  <Image
    ...
    alt="Add Variable dialog with Name and Value input fields"
    width="450"
  />
</p>

To delete an existing variable, click on the **Remove** button on the right. You'll have to confirm your choice before the variable is deleted. Deleted variables can't be recovered, so be careful when doing this.

<p align="center">
  <Image
    src={require("@site/static/img/variables-delete+1.32.png").default}
    alt="Variables table showing a user variable with a masked value and a Remove button"
    width="650"
  />
</p>
...
<p align="center">
  <Image
    ...
    alt="Admin Dashboard showing the Admin Variables page with a table of variables and Remove buttons"
    width="650"
  />
</p>
...
<p align="center">
  <Image
    src={require("@site/static/img/variables-delete+1.32.png").default}
    alt="Admin variables table showing variables with masked values and Remove buttons"
    width="650"
  />
</p>
