...
<p align="center"><Image src="/docs/core/images/private-endpoints.png" alt="private endpoints UI" width="850" /></p>
...
> Private Endpoints generated this way follow the same rules and restrictions than [Automatic SSL Endpoints](core/ingress/automatic-ssl.mdx).
