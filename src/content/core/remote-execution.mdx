...
By default, your commands run locally in your machine, but we recommend to enable [remote execution](reference/okteto-manifest.mdx#deploy-remotely).
...
If you define `OKTETO_FORCE_REMOTE=true` as an [Admin Variable](admin/dashboard.mdx#variables), Remote Execution is enable for all your commands.

:::warning

Local execution is deprecated. Okteto recommends to enable Remote Execution for your deploy/destroy commands
