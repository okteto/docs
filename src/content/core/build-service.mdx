...
<p align="center">
  <Image
    ...
    alt="Build flow from Okteto Manifest through okteto build to a remote BuildKit server, which pushes the image to Okteto Registry"
    width="850"
  />
</p>
...
On Self-Hosted installations, Admins can run the BuildKit server in [rootless mode](self-hosted/helm-configuration.mdx#rootless) so that builds do not run in a privileged container.
...
<p align="center">
  <Image
    ...
    alt="Smart Builds computing a content hash from the Okteto Manifest and pushing the image to Okteto Registry"
    width="850"
  />
</p>
...
<p align="center">
  <Image
    ...
    alt="Smart Builds re-tagging cindy/api:okteto to the shared hash okteto/api:09f8e in Okteto Registry"
    width="850"
  />
</p>
...
<p align="center">
  <Image
    ...
    alt="Smart Builds skipping a duplicate build and re-tagging david/api:okteto to the existing hash"
    width="850"
  />
</p>
