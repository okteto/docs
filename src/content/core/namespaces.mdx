...
The Okteto Dashboard allows you to easily create, [sleep](admin/cleanup.mdx#sleeping-resources), and [wake up](admin/cleanup.mdx#wake-sleeping-resources) your Namespaces with a simple click. Specifically, you can use the Sleep and Wake dialogs for controlling your Namespace's state.
...
- [Sleep](admin/cleanup.mdx#sleeping-resources) or [wake up](admin/cleanup.mdx#wake-sleeping-resources) your namespace with `okteto namespace sleep [name]` and `okteto namespace wake [name]` commands respectively
