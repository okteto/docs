...
- Configue cpu, memory, pods and storage quotas for each Namespace using [the `quotas` section within the Okteto Helm configuration](self-hosted/helm-configuration.mdx#quotas).
