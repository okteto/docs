...
The Okteto Admin Dashboard allows you to [sleep](admin/cleanup.mdx#manually-sleeping-resources) and [wake up](admin/cleanup.mdx#manually-wake-sleeping-resources) your Namespaces with a single click. Specifically, you can use the **Put To Sleep** and **Wake Up** actions in the Namespace menu to control your Namespace's state.
