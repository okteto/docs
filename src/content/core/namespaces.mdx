...
The Okteto Dashboard allows you to easily create, [sleep](admin/cleanup.mdx#manually-sleeping-resources), and [wake up](admin/cleanup.mdx#manually-wake-sleeping-resources) your Namespaces with a simple click. Specifically, you can use the Sleep and Wake dialogs for controlling your Namespace's state.
