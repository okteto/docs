...
**Important**: For shared automations like [Preview Environments](preview/overview.mdx) it's recommended to use [Admin Access Tokens](admin/dashboard.mdx#admin-access-tokens) instead. They're created in the same way as described here under, but through the [Admin dashboard](admin/dashboard.mdx#admin-access-tokens) instead.
