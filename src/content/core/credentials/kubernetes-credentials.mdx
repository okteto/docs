...
If this is your first time using the Okteto CLI, install it following [this guide](development/using-okteto-cli.mdx). After completing those steps, the Okteto CLI should be in your PATH.
