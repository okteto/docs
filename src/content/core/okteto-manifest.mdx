...
Tests can de defined independenty using this section and will be executing sequentially. Test can also depend on each other and be linked via a `depends_on` field which defines the order of test executions.
