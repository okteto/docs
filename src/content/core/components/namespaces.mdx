...
To transfer a namespace to a new owner, go to the Okteto UI -> Admin -> Namespaces then locate the namespace that you would like to transfer. Click on the three dots `...` to display the namespace menu. From the namespace menu select `Change Owner`.
...
New user specific variables can be added to a transferred namespace if desired to avoid future failures.
