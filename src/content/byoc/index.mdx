---
title: Okteto Bring Your Own Cluster (BYOC)
description: Introduction to Okteto Bring Your Own Cluster (BYOC)
---

Okteto’s Bring Your Own Cluster (BYOC) offering allows you to run Okteto on your own cloud infrastructure while still enjoying the benefits of a fully managed experience.
...
With BYOC, you bring the infrastructure; we bring the platform and operational expertise.

- You provision and secure the cloud account and Kubernetes cluster
- Okteto installs the necessary components and connects the cluster to our control plane
- Our team manages and maintains Okteto on your cluster, including upgrades, monitoring, and incident response
- You retain full ownership of your cloud environment and data

## 🤝 What You Can Expect from Okteto

When you connect your cluster to Okteto:

- Okteto installs and manages its components in your cluster
