...
- Disable VPC Block Public Access. Okteto uses internet-facing load balancers to expose applications. Okteto can restrict the load balancer that exposes your applications to a list of allowed IP ranges (CIDR blocks). Contact your Okteto representative to set this up.
:::
