...
Okteto's Bring Your Own Cluster (BYOC) model allows you to run the Okteto Platform in your own AWS account while still benefiting from a fully managed experience.
...
Finally, provide the IAM Role ARN to your Okteto sales representative. They’ll complete the setup and guide you through connecting your cluster to Okteto.
