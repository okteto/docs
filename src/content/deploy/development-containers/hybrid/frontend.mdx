...
This tutorial will show you how to develop a Frontend application using Okteto Hybrid Mode.
...
The `frontend` key matches the name of the **frontend** Deployment. The meaning of the rest of fields is:
