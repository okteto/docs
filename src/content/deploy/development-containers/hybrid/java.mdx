...
This tutorial will show you how to develop and debug a Java application using Okteto Hybrid Mode.
...
The `vote` key matches the name of the **hello world** Deployment. The meaning of the rest of fields is:
...
- `forward`: to expose the kafka port 9092 on localhost to access kafka fron your local machine
