...
Development Containers allow you to hot reload and debug your Development Environments **as fast as you type code** 🚀

Development Containers support two different modes:

- [File Sync development mode](file-sync/index.mdx): syncs your local changes to your remote Development Conainer (default mode)
- [Hybrid development mode](hybrid/index.mdx): runs you service locally and simulates your laptop belongs to the cluster network by using ssh tunnels
