...
Please make sure to configure your Git repositories with the [appropriate manifests](core/using-okteto-cli.mdx#deployment-manifests) before using them to deploy Dev Environments.
