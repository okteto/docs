...
Note that your Git repository needs to be configured with an [Okteto Pipeline](deploy/okteto-pipeline).
Read the Okteto Pipeline [getting started guide](deploy/using-the-cli/#okteto-manifest) to learn how to create an Okteto Pipeline for your Git repository. -->

## Prerequisites

Please make sure to configure your Git repositories with the [appropriate manifests](deploy/using-the-cli/#deployment-manifests) before using them to launch Dev Environments.
...
<p align="center"><Image src="/docs/deploy/images/deploy-git.png" alt="deploy from git" width="650" /></p>
...
<p align="center"><Image src="/docs/deploy/images/ui-movies-git.png" alt="UI of the movies app" width="850" /></p>
...
<p align="center"><Image src="/docs/deploy/images/redeploy-git.png" alt="Redeploy in git" width="600" /></p>
...
<p align="center"><Image src="/docs/deploy/images/destroy-git.png" alt="Destroy application" width="450" /></p>
...
- `filename`: The location of the [Okteto Manifest](reference/okteto-manifest) relative to the root of the repository.