...
Note that your Git repository needs to be configured with an [Okteto Pipeline](deploy/okteto-pipeline.mdx).
Read the Okteto Pipeline [getting started guide](core/using-okteto-cli.mdx#okteto-manifest) to learn how to create an Okteto Pipeline for your Git repository. -->

## Prerequisites

Please make sure to configure your Git repositories with the [appropriate manifests](core/using-okteto-cli.mdx#deployment-manifests) before using them to launch Dev Environments.
