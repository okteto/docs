...
Read the Okteto Pipeline [getting started guide](deploy/using-the-cli.mdx#okteto-manifest) to learn how to create an Okteto Pipeline for your Git repository. -->

## Prerequisites

Please make sure to configure your Git repositories with the [appropriate manifests](deploy/using-the-cli.mdx#deployment-manifests) before using them to launch Dev Environments.
