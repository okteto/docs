...
Another option available is [Okteto Self-Hosted](https://www.okteto.com/pricing/). Okteto Self-Hosted gives you all the features of Okteto SaaS - on your own infrastructure. This offers you full control of your Kubernetes infrastructure while delivering the same smooth experience you expect from Okteto SaaS. The Okteto Self-Hosted [documentation](/get-started/overview.mdx) covers how you can get started with it.
