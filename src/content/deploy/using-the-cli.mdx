...
- [File Synchronization](/manage-app/file-synchronization.mdx)
- [SSH Server](/manage-app/connect-via-ssh.mdx)
- [FAQs](/community-support/faqs.mdx)
...
The Okteto manifest allows you to provide configuration for building, deploying, and developing your application in a Development Environment. This file is optional if you already have a Docker Compose file for your application. Learn more about the Okteto manifest [here](/reference/okteto-manifest.mdx).
...
- `OKTETO_REGISTRY_URL`: the url of the [Okteto Registry](components/container-registry.mdx).
...
You can also configure your own [container image](/reference/okteto-manifest.mdx#deploy-remotely) to use your own tools in your `deploy` commands.
