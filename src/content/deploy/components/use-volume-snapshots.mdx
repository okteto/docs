...
Follow [this guide](self-hosted/manage/configure-volume-snapshots) to enable Volume Snapshots in your cluster.
...
- [Create the source persistent volume](deploy/use-volume-snapshots/#creating-the-persistent-volume)
- [Create a volume snapshot of the source persistent volume](deploy/use-volume-snapshots/#creating-a-volume-snapshot)
- [Consume the volume snapshot in a new persistent volume](deploy/use-volume-snapshots/#consuming-a-volume-snapshot)
...
Check the [requirements](deploy/use-volume-snapshots/#requirements) section to learn more about the available storage classes in Okteto.
