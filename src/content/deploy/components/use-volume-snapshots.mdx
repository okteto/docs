...
Follow [this guide](get-started/configure/configure-volume-snapshots.mdx) to enable Volume Snapshots in your cluster.
...
- [Create the source persistent volume](deploy/use-volume-snapshots.mdx#creating-the-persistent-volume)
- [Create a volume snapshot of the source persistent volume](deploy/use-volume-snapshots.mdx#creating-a-volume-snapshot)
- [Consume the volume snapshot in a new persistent volume](deploy/use-volume-snapshots.mdx#consuming-a-volume-snapshot)
...
Check the [requirements](deploy/use-volume-snapshots.mdx#requirements) section to learn more about the available storage classes in Okteto.
