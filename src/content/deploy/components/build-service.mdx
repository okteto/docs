...
You'll need the [Okteto CLI](reference/using-the-cli) in order to access the Okteto Build Service.
...
[Refer to this document](reference/okteto-cli#build) for more information on the `okteto build` command.
