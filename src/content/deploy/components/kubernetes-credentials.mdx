...
If this is your first time using the Okteto CLI, install it following [this guide](deploy/using-the-cli). After completing those steps, the Okteto CLI should be in your PATH.
