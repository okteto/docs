...
To pull an image from a different namespace, you'll need to create and configure the required `imagePullSecrets` as outlined [here](welcome/faqs.mdx#how-to-use-private-images).
