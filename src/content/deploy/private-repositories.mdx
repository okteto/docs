...
[This document](manage-okteto/private-repositories/ssh-key-auth.mdx) has more information on how to configure access to the private repository in your source code provider.
