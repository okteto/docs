...
The easiest way to validate this is to follow the instructions in the [Deploy from Git](deploy/deploy-from-git) document.
...
- `filename`: The location of the [Okteto manifest](reference/okteto-manifest) relative to the root of the repository. If not set, one of the [deployment related manifests](deploy/using-the-cli/#deployment-manifests) will be used.
