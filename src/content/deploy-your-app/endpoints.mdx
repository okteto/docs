...
Looks like there is still an issue with the Movies app. If you check the logs of the **api** Kubernetes Deployment:
...
You can see that the **api** is failing to connect to MongoDB... Let's fix that in the [next step](deploy-your-app/dependencies.mdx) of this guide!