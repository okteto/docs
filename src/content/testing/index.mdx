...
This is how the software development process looks like for application based on microservices before adopting Okteto:

<p align="center">
  <Image
    src={require("@site/static/img/classic-software-development.png").default}
    alt="Diagram comparing development, CI, and production stages running on different platforms: local environment, virtual machine, and Kubernetes"
    width="850"
  />
</p>
...
<p align="center">
  <Image
    ...
    alt="Diagram showing development and production both running on Kubernetes with Okteto, while CI still runs on a virtual machine"
    width="850"
  />
</p>
...
<p align="center">
  <Image
    ...
    alt="Diagram showing development, CI, and production all running on Kubernetes with Okteto for consistent environments"
    width="850"
  />
</p>
