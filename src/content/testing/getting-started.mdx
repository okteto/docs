---
title: Getting started with Test Containers
description: In this section, we'll see how you caconfigure Test Containers for your application
sidebar_label: Getting Started
id: getting-started
---

This guide explains how to configure Test Containers for your first app to Okteto.
...
- You have complited [our guide to deploy your first app to Okteto](get-started/deploy-your-app/index.mdx)

## What you will be building

This tutorial will guide you on how to test [Movies app](https://github.com/okteto/getting-started) using Okteto.
...
The [test](reference/okteto-manifest.mdx#dev-object-optional) section in the Okteto Manifest defines how to test the Movies App.

For example, add the Test Container to run unit tests for the `frontend` service is like this:
...
`frontend` is the name of the Test Container. The meaning of the rest of fields is:
...
- `caches`: a list of folders to persist between executions of the Test Container. This is very important for performance of your Test Containers.
- `commands`: a list of commands to execute your tests.

Also, note that there is a `.oktetoignore` file in the `frontend` folder to indicate which files shouldn't be synchronized to your Test Container.
...
The first executon takes longer because the `caches` aren't initialize, but you will get this output:
...
This is very convinient in monorepos, since Okteto won't rerun unit tests in the folder has no changes.
