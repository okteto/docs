...
Okteto requires a license key to use any of our paid products. If you use Okteto SaaS then no action is required of you to obtain a license as this is fully managed by Okteto. If you use Okteto Self-Hosted, then you will need to obtain a license and include that in your `config.yaml` when installing Okteto.

:::note
You can also optionally include your Okteto license using [Secrets](get-started/configure/configuration-settings.mdx#cloud-provider-secret).
:::
