...
<p align="center"><Image src="/docs/manage/images/gc_add_repo_sidebar.png" alt="add a repository to the Catalog" width="900" /></p>
...
<p align="center"><Image src="/docs/manage/images/gc_add_env_vars.png" alt="add environment variables to Catalog repo" width="800" /></p>
...
<p align="center"><Image src="/docs/manage/images/gc_launch_dev_env.png" alt="launch a development environment from the Catalog" width="600" /></p>

<p align="center"><Image src="/docs/manage/images/gc_view_env_vars.png" alt="view a Catalog repo's environment variables" width="600" /></p>
