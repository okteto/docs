...
1. Open a terminal and point the Okteto CLI to your Okteto instance by running:
...
2. You’ll be taken to the browser and asked to authenticate. Once that is done, Okteto CLI is configured and ready to be used with your development environments.
...
For more detailed information and advanced features, visit the [Okteto Documentation](https://okteto.com/docs).
