...
1. Open your web browser and navigate to your Okteto instance URL. It should look something like `https://okteto.mycompany.com`
...
## Step 4: Connect to Your Okteto Instance

1. If you haven't already, [install the Okteto CLI following the guide here](get-started/install-okteto-cli.mdx).
2. Open a terminal and point the Okteto CLI to your Okteto instance by running:

   ```bash
   okteto context
   ```

   And then typing in the URL for your Okteto instance when prompted. It should look something like `https://okteto.mycompany.com`.

3. You’ll be taken to the browser and asked to authenticate. Once that is done, Okteto CLI is configured and ready to be used with your development environments.

## Step 5: Start Your Development Container

1. Clone the repository of the application you just deployed to your local machine.
...
2. Start the development process by running the relevant command for your application. For example, for a React application, run:

   ```bash
   yarn start
   ```

## Step 7: Sync Code and View Changes
...
- **No Configuration Required**: You can start writing code immediately using the preconfigured applications in the Okteto catalog.
...
Dive into learning about Okteto by following our [Developer Manual here](/get-started/dev-quickstart.mdx).
