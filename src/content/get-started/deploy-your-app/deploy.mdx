...
For this tutorial, you will be using our getting started sample app. Start by cloning the follwoing repo repo:
...
But the Okteto CLI is informing that `There are no available endpoints for 'movies'`...
