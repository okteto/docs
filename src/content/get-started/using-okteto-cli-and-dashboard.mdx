...
description: The Okteto CLI and Dashboard provide tools for building, deploying, and managing Development Environments.
...
It manages the entire lifecycle of your application, from building and deploying to testing and ongoing development.
...
- Automate your development setup: Deploy your application configuration and set up the Development Environment with a single command
...
See the [Okteto Manifest overview](core/okteto-manifest.mdx) for a complete reference of all available fields.

## Essential Okteto CLI Commands

The Okteto CLI is an [open-source](https://github.com/okteto/okteto) tool that lets you develop your applications on Okteto.
If you haven't done so yet, install and configure the Okteto CLI following [this guide](get-started/install-okteto-cli.mdx).

Most developers interact with Okteto via the CLI. The following table lists the most common commands and a typical workflow for using them.
...
You can find all available commands in the [CLI reference](reference/okteto-cli.mdx).
...
### 2. **Using the Catalog to Deploy a Development Environment**
   ...
   <p align="center">
      <Image
         ...
         alt="deploying an environment from the Okteto catalog"
         width="800"
      />
   </p>
...
### 4. **Sharing a Namespace**
   ...
   <p align="center">
      <Image
         ...
         alt="sharing a namespace with another user"
         width="800"
      />
   </p>

   See [sharing and collaboration with Namespaces](core/namespaces.mdx#sharing-and-collaboration-with-namespaces) for details.
...
### 5. **Environment States**
   ...
   - **Persistent**: Admins can choose to prevent Namespaces from deletion and automatically sleeping so that they are always accessible
...
### 6. **Preview Environments**
   ...
   <p align="center">
      <Image
         ...
         alt="preview environments in the Okteto dashboard"
         width="800"
      />
   </p>

   See the [Preview Environments](previews/index.mdx) documentation for details.

### 7. **Checking the installed Okteto version**

   To check which version of Okteto your instance is running, click the **Help** item at the bottom of the main menu. The installed version appears at the bottom of the Help panel.

## Next Steps

Now that you know more about how to use Okteto, let's explore some [advanced commands and concepts](get-started/advanced-commands-and-concepts.mdx).
