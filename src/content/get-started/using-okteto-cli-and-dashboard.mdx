...
| [`okteto deploy`](reference/okteto-cli.mdx#deploy)    | Deploy your application                                                                                                        |
| [`okteto build`](reference/okteto-cli.mdx#build)      | Build a new image for your Development Environment. This will build and push the images defined in the build section of your Okteto Manifest.   |
| [`okteto up`](reference/okteto-cli.mdx#up)            | Start your Development Environment and connect your terminal window to the cloud environment                                    |
| [`okteto down`](reference/okteto-cli.mdx#down)        | Stops your development environment                                                                                              |
