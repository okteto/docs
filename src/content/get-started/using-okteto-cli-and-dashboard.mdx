...
The Okteto CLI is our [open-source](https://github.com/okteto/okteto) tool that lets you develop your applications on Okteto.
...
### 7. **Viewing Real-Time Resource Logs**

   The Okteto dashboard also lets you inspect every resource running in your Namespace. Select a Namespace to list its resources, then click on any resource to stream its logs in real time, directly from the dashboard. This makes it easy to monitor and debug your applications without having to switch to `kubectl` or the CLI.

### 8. **Help menu**

   Click the **Help** item at the bottom of the main menu to access quick links to documentation, community resources, and support. The Help panel also displays the installed Okteto version at the bottom, which is useful when reporting issues or verifying your environment.
