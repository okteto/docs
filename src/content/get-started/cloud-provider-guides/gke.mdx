...
- A working installation of Helm v3 (v3.8 or higher) (v3.8 or higher)
- An Okteto License

### Subdomain

You'll need sufficient access to a [subdomain](reference/helm-chart-settings.mdx#subdomain) to add a wildcard DNS record, such as dev.example.com.
