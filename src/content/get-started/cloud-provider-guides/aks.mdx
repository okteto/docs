...
id: microsoft-aks
pagination_next: install-okteto-cli
---
...
You'll need sufficient access to a [domain](reference/helm-chart-values.mdx#subdomain) to add a wildcard DNS record, such as dev.example.com.
