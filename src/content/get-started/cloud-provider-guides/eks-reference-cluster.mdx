...
sidebar_label: Create an AWS EKS reference cluster
...
Follow this step-by-step tutorial to streamline deploying Okteto in a Kubernetes environment on AWS.
...
Use the snippet below to use your current AWS Region or [choose your own value](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-regions-availability-zones.html#concepts-available-regions).
