...
This guide will show you how to install Okteto in Amazon Elastic Kubernetes Service (EKS).
...
- A Kubernetes cluster
  - Follow our [Amazon EKS Reference Guide](get-started/cloud-provider-guides/eks-reference-cluster.mdx) to quickly create a Kubernetes cluster suitable for Okteto
...
Follow our [step-by-step EKS Reference Cluster guide](get-started/cloud-provider-guides/eks-reference-cluster.mdx) to quickly set up a new Kubernetes cluster suitable for running Okteto.

Okteto supports Kubernetes versions {variables.kubernetesMinVersion} through {variables.kubernetesMaxVersion}.

You can also follow Amazon's [cluster creation guide](https://docs.aws.amazon.com/eks/latest/userguide/create-cluster.html).
