...
### Configure a private registry with Amazon ECR

This tutorial will guide you on how to use a private registry in Amazon Web Services, its necessary credentials, and how to use it in Okteto.
...
Or, configure manually. Find the `IAM Service` in the **AWS Console,** and follow this steps:
...
:::info
It is more recommended to use groups, and add the user and policy to that group
:::
...
**Step 4: Add to the Okteto Admin Dashboard**
