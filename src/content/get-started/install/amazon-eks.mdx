...
### Optional: Configure a private registry with Amazon ECR

[Review our guide here](admin/registry-credentials/amazon-ecr.mdx) for getting and storing your Amazon ECR credentials.
