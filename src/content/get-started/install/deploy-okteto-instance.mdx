...
Before running `helm install`, we recommend that you create a yaml configuration file with your choices about how to install Okteto. This guide will walk you through the default installation. A complete list of configuration options is [available here](get-started/configure/configuration-settings).
...
> **Important**: The default installation is not recommended for production use. We highly advise following the steps outlined in the [Admin Dashboard](manage-okteto/admin-dashboard/#installation) before giving your team access to your Okteto instance.
