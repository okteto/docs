...
- [Install Okteto in Amazon Elastic Kubernetes Service](self-hosted/guides/amazon-eks)
- [Install Okteto in Azure Kubernetes Service](self-hosted/guides/microsoft-aks)
- [Install Okteto in Civo](self-hosted/guides/civo)
- [Install Okteto in Google Kubernetes Engine](self-hosted/guides/google-gke)
- [Install Okteto in DigitalOcean Kubernetes](self-hosted/guides/digitalocean-doks)
...
1. [Prerequisites](get-started/install/prerequisites)
2. [Deployment](get-started/install/deploy-okteto-instance)
...
Instructions on how to upgrade your Okteto instance [are available here](get-started/install/upgrade-okteto-instance).

Please review [the release notes before upgrading](additional-resources/releases). New features, known issues, and configuration changes will be listed there.
