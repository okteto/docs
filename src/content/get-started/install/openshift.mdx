...
```
:::info
Note: The secret name `<openshift-cluster-name>-primary-cert-bundle-secret` is commonly used in OpenShift 4.x. Replace it with the actual secret name if it's different in your cluster.
:::
