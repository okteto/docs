...
Copy the certificate to the `okteto` namespace by running:
...
:::info
The secret name `<openshift-cluster-name>-primary-cert-bundle-secret` is the default used in OpenShift 4.x. If you installed OpenShift with your own certificate, refer its secret here.
:::
...
:::info
If you installed OpenShift with your own certificate and CA, follow this guide to [configure the same certificate](self-hosted/install/certificates/bring-your-own-certificate.mdx) in the `wildcardCertificate` section
:::
