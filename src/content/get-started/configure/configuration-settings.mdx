...
- [Azure Active Directory](self-hosted/auth-providers/azure-active-directory/index.mdx)
- [Gitlab](self-hosted/auth-providers/gitlab/index.mdx)
- [Okta](self-hosted/auth-providers/okta/index.mdx)
...
- `runner`: to configure your [custom installer image](custom-installer-image.mdx).
...
There is only one exception where this storage class is overwritten. In case of having [volume snapshots feature](configure-volume-snapshots.mdx) configured, if a storage class is required for the snapshots that storage class will have preference.
