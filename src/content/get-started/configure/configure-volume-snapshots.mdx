...
More information on the different configuration settings [is available here](get-started/configure/configuration-settings/#volumesnapshots).
...
Follow [this guide](deploy/components/use-volume-snapshots/#using-volume-snapshots-in-your-development-environment) to use Volume Snapshots in your development environment.
