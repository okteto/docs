...
Follow our [Amazon EKS Reference Guide](get-started/cloud-provider-guides/eks-reference-cluster.mdx) to quickly configure a Kubernetes cluster to deploy Okteto in.
