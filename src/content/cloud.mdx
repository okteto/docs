...
- Deploy your development environments from [Git Repositories](/docs/cloud/deploy-from-git/), [Docker Compose](/docs/tutorials/compose-getting-started/) files or [Helm Charts](/docs/cloud/deploy-from-helm/).
...
- Push your container images in [Okteto Registry](/docs/cloud/registry).
