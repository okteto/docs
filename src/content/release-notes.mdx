...
- Added onboarding guides to our documentation on [how to get started with Okteto Insights](core/okteto-insights.mdx) <!-- 729 -->
...
- [Okteto Insights](core/okteto-insights.mdx): Pod v2, Build, Deploy, User, Namespace, and Preview metrics are now available <!-- 7897, 7906, 7898, 7900 -->
...
- Add [Pod metrics to Okteto Insights](core/okteto-insights.mdx#pod-metrics)  <!-- 7594 -->
...
- Add `okteto_usage_build_duration_seconds` build metrics to okteto insights. More info [here](core/okteto-insights.mdx) <!-- 7445 -->
...
- Added a new `/metrics` endpoint to expose prometheus node metrics data. More info [here](core/okteto-insights.mdx).
