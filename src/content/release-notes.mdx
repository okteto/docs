...
- Added read-only mode for [Known Hosts configuration](self-hosted/manage/custom-resource-definitions.mdx#known-hosts), allowing admins to lock down SSH host key management and prevent accidental modifications <!-- 9726 -->
