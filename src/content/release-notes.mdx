...
- Add support for Openshift: Openshift Routes now show as Okteto Endpoints  <!-- 8025 -->
- Enable Pull Secrets by default  <!-- 8001 -->
...
- Added the ability to assign a PriorityClass to Okteto components  <!-- 7966 -->
- Added custom tolerations to the Helm Chart and standardize their helm values  <!-- 8029 -->
- Fixed an issue with Custom Tolerations: The Registry will no longer inherit Buildkit tolerations  <!-- 8073 -->
...
- Updated CLI version in the backend to 2.27.1  <!-- 8089 -->
...
- Support for Kubernetes [1.25](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.25.md) has been deprecated and removed in this release.
