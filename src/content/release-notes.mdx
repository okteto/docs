...
- Okteto CLI 2.30.0: You can now Build images using the `okteto build` command as part of your custom commands in the Okteto Manifest when executing a remote deploy/destroy. Previous to this, no image was being built
- Okteto CLI 2.30.0: You can now [specify hosts](reference/okteto-manifest.mdx#hosts-string-optional) to resolve to specific IPs for your tests defined under the `test` section of the Okteto Manifest
