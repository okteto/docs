...
- Added support for [Kubernetes 1.33](https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.33.md) (support for 1.30 has been removed) and [Amazon Linux 2023](https://github.com/amazonlinux/amazon-linux-2023)
- Namespace deletion now includes a configurable timeout to help with stuck cleanups  
...
- Fixed an issue that prevented some development environments from waking up as expected  
- Improved AWS IAM Role regex handling for tighter validation
