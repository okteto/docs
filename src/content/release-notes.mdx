...
- Announcing Cloud Credentials, a central location to manage your authentication with AWS and GCP  <!-- 8550 -->
- Enabling Okteto Insights for all users of Okteto <!-- 8627 -->
- Added configurable buildkit network mode  <!-- 8486 -->
- Init dynamic config  <!-- https://github.com/okteto/app/pull/8475 -->
- Added CLI, Chart, and Okteto App version to our API headers  <!-- 8545 -->
- Support to enable/disable resource quotas for individual Namespaces  <!-- 8604 -->
- Allow override of installer security context  <!-- https://github.com/okteto/app/pull/8608 -->

### Improvements

- Show more actionable feedback upon "failed to deploy okteto pipeline"…  <!-- 8521 -->
...
- Fixed collapsed content not being accessible   <!-- 8522 -->
- Replaced `Input` with `FormField` in the login view  <!-- 8510 -->
