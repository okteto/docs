...
- We now allow the ability for admins of Okteto to [set the minimum supported CLI version for their team](admin/dashboard.mdx#command-line-cli)  <!-- 8829 -->
...
- feat: send cli image on graphql clustermetadata  <!-- 8914 -->

### Improvements

- We've reorganized the [Admin Dashboard menu items](admin/dashboard.mdx) into groups for easier navigation  <!-- 8840 -->
- Added readonly tags in the Dashboard to Catalog, Cloud Credentials, and Registry Credential items that were created via CRDs  <!-- 8886 -->
- Updated buildkit cacheRatio value to `0.8`  <!-- 8921 -->
- feat: `wake`, `sleep` & `destroyall` rootless (PLAT-738)  <!-- 8919 -->
- feat: support for rootless runner and installer  <!-- 8913 -->
