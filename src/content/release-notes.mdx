...
- Added support for waking up Development Environments via Docker Compose annotations; `depends_on` is now respected [with a feature flag](reference/feature-flags.mdx)  <!-- 9187 -->
