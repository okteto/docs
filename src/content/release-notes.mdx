...
- Updated the backend CLI to version 2.29.2 to fix critical vulnerabilities
- Fix critical vulnerabilities in backend and installer images
- Bump builkit image to v0.12.5-okteto3 to fix critical vulnerabilities
...
- Updated the backend CLI to version 2.28.2 to fix critical vulnerabilities
- Fix critical vulnerabilities in backend and installer images
- Bump builkit image to v0.12.5-okteto3 to fix critical vulnerabilities
