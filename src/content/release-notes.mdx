...
- Adding support for [resource quotas at the individual Namespace level](core/namespaces.mdx#configure-namespace-quotas). This allows administrators to set the maximum resources that can be used per Namespace
...
- Added support to [enable/disable resource quotas for individual Namespaces](self-hosted/helm-configuration.mdx#quotas). The new default values do not enforce a resource limit  <!-- 8604 -->
...
- Now showing more actionable feedback upon "failed to deploy okteto pipeline"…  <!-- 8521 -->
