...
- Okteto Insights: Pod v2, User, Namespace, and Preview metrics are now available <!-- 7897, 7906, 7898, 7900 -->
...
- Add Grafana endpoint to `cluster/general` to support Oketeo Insights for SaaS plan users  <!-- 7861 -->
- maxNamespaces quota should no longer affect the okteto-bot user  <!-- 7905 -->
- Rename OKTETO_CURRENT_DEPLOY_BELONGS_TO_PREVIEW to OKTETO_IS_PREVIEW_ENVIRONMENT and allow it to be used for destroy operations  <!-- 7904 -->
...
- Fix UI breaking endpoint links that span the full width of container  <!-- 7837 -->
