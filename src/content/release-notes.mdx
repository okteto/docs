...
- **Builds Dashboard**: Track and analyze your build performance with the new [Builds dashboard in Okteto Insights](core/okteto-insights-dashboards.mdx#builds-dashboard). Monitor build metrics, success rates, and performance trends across your organization to optimize your CI/CD pipeline
