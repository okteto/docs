...
- Added support for waking up Development Environments via Docker Compose annotations; `depends_on` is now respected [with a feature flag](reference/feature-flags.mdx) (requires redeploying the application with [Okteto CLI 3.6.0](https://github.com/okteto/okteto/releases/tag/3.6.0)) <!-- 9187 -->
