...
- [Remote Execution can now be set as the default](core/remote-execution.mdx) in the Okteto Admin Dashboard, allowing admins to enforce consistent remote deploys. Improvements include feature parity with local deploys, such as context synchronization and private Git repository cloning during deploys
