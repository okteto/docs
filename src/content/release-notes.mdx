...
This versions is compatible with Kubernetes versions 1.27 to 1.31 \
...
- Resolved issues with job manifests by reverting security context changes, ensuring CLI execution as root when necessary  <!-- 8973 -->
- Corrected permissions for Docker config setup in job manifests  <!-- https://github.com/okteto/app/pull/9003 -->
- Addressed inconsistent states in the logs filters within the UI to improve reliability  <!-- https://github.com/okteto/app/pull/9015 -->
