...
- Enable [Pull Secrets by default](admin/registry-credentials/index.mdx#pull-secrets-vs-kubelet-reconfiguration). If you do not wish to manage pull secrets, please see our [upgrade guide](self-hosted/manage/upgrade.mdx#upgrading-to-okteto-120x) to disable.  <!-- 8001 -->
