...
- **Restart Build Pods**: Administrators can now [restart individual build service pods directly from the Okteto Admin panel](admin/build-service.mdx#restarting-a-buildkit-pod). This makes it easier to recover from build service issues without requiring CLI access or contacting Okteto support.
