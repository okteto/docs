...
### [AI Agent Fleets Now Available (Beta)](ai-agent-fleets/index.mdx)
AI Agent Fleets brings the power of AI directly into your development workflow, powered by Claude Code from Anthropic. Each agent operates independently in its own Kubernetes namespace with full isolation, giving you the safety and control you need for AI-assisted development.
...
#### For Administrators
Organization administrators have [full control over AI Agent Fleets deployment](ai-agent-fleets/ai-agent-fleets-admin-config.mdx):
- Enable the feature for your organization through the Admin Dashboard under Admin > AI Agent Fleets
...
We're continuously improving AI Agent Fleets based on your feedback. Try it today and let us know how it transforms your development workflow!
