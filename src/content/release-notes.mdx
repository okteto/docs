...
- Okteto CLI: [Smart Builds implementation](core/build-service.mdx#smart-builds) now uses `build: context` instead of `project: commit`
...
- Introduced the OKTETO_IS_PREVIEW_ENVIRONMENT environment variable for development and preview environments, enabling its use in destroy operations  <!-- 7904 -->
