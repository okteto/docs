...
- Announcing the beta release of Okteto CLI 3.0 [Will link to blog post]
- Upgraded [ingress-nginx to v1.11.2](https://github.com/kubernetes/ingress-nginx/releases/tag/controller-v1.11.2). This `ingress-nginx` breaking change is only related to an [uncommon edge case](https://github.com/kubernetes/ingress-nginx/issues/11866)  <!-- 8460 -->
