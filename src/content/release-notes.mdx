...
- [Okteto CLI 3.7.0](https://github.com/okteto/okteto/releases/tag/3.7.0): Fixed a bug on the [Smart Builds](core/build-service.mdx#smart-builds) hash calculation process that was hanging the process forever when the local git repository has hundred of untracked files
