...
- gc cronjob now resolves buildkit and ingress hosts to their internal IPs  <!-- 7432 -->
...
- When telemetry is enabled, Okteto now export cluster configuration to Mixpanel on every helm upgrade.
- Okteto now provides a diagnostics tool to help troubleshoot installation. More info [here](https://www.okteto.com/docs/1.16/self-hosted/manage/diagnostics/)
