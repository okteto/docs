...
This versions is compatible with Kubernetes versions 1.25 to 1.28.

### New Features

- Enable search in namespace resources UI  <!-- 7577 -->
- Enable admins to [transfer namespace ownership](core/components/namespaces/#transfer-namespace-ownership)  <!-- 7593 -->
- Add [Pod metrics to Okteto Insights](admin/okteto-insights/#pod-metrics)  <!-- 7594 -->

### Improvements

- Hoist Personal Access Tokens menu from Setup to Settings  <!-- 7574 -->
- Rename Launch → Deploy for all UI  <!-- 7576 -->
- Rename Secrets -> Variables under both Settings and Admin sections. This rename is for consistency in the UI and delivers no change in functionality   <!-- 7581 -->
- Support multi-line secrets  <!-- 7580 -->
...
- Move garbage collection of `okteto up` based on last synced file behind a feature flag. More info [here](reference/helm-chart-values.mdx#gc) <!-- 7424 -->
...
- Updates to [**Cloud Secret**](reference/helm-chart-values.mdx#cloud-provider-secret) now take immediate effect <!-- 7032 -->
