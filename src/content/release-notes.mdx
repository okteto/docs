...
- Disable private registries in nodes  <!-- 8215 -->
- Removed the automatic binding to every service account created within a namespaces managed by Okteto  <!-- 8245 -->

### New Features

- Add OIDC info to cluster overview  <!-- 8151 -->
- Private Registries AWS IAM Roles  <!-- 8104 -->
- Add AWS IAM Role credentials to regcreds table  <!-- 8221 -->
- New option in Admin > General to show up OIDC info  <!-- 8198 -->
- Add AWS IAM Role read/create/update dialogs  <!-- 8224 -->
- Make Preview Environments global by default and allow non-admin users to create/delete them  <!-- 8217 -->

### Improvements

- Changed Admin Users' role select label from "User" to "Developer" for consistency  <!-- 8202 -->
- Fixed tolerations & Nodeselector warnings  <!-- 8219 -->
- Improved Okteto Insights data collection time  <!-- 8222 -->
- Reorganized 'user' helm setting to 'serviceAccounts' and include one setting to create a role binding for global previews  <!-- 8233 -->
- Specified the credentials to be removed in the confirmation dialog  <!-- 8250 -->
- Added OIDC documentation links to the UI  <!-- 8254 -->
- Reduced the time to consider a namespace-destroy-all to be destroyable  <!-- 8262 -->

### Bug Fixes

- Fixed a rare issue where the Okteto Dashboard would render nothing during loading  <!-- 8199 -->
- Fixed unmarshalling of the `exportTo` object in the Manifest  <!-- 8204 -->
...
- Added error boundary in the Dashboard to catch unexpected errors  <!-- https://github.com/okteto/app/pull/8239 -->
- Fixed panic in private-endpoints handler when it is deployed in a standalone component  <!-- 8260 -->
