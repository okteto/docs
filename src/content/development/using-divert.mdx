...
### Verify Sidecar Injection (nginx driver with Linkerd)

These checks apply only if your Admin installed Linkerd. If your cluster runs the nginx driver without Linkerd, skip this section.
...
- [ ] Linkerd sidecars are running in your pods (only if your cluster uses Linkerd)
