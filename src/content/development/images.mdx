...
1. Build your image in the [build](core/okteto-manifest.mdx#build) section of the Okteto manifest
1. Update the `image` key in your `okteto.yaml` with your new image using the [OKTETO_BUILD_XXX](core/okteto-variables.mdx#built-in-environment-variables-for-images-in-okteto-registry) variables
