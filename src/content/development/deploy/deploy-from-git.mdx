...
<p align="center">
  <Image
    src={require("@site/static/img/deploy-git+1.42.png").default}
    alt="Deploy Dev Environment dialog with GitHub source selected and a repository URL entered"
    width="650"
  />
</p>

When you deploy a dev environment using a Git repository, Okteto analyzes your repo and automatically deploys it by running `okteto deploy`.
...
<p align="center">
  <Image
    ...
    alt="Okteto UI showing the deployed Movies app with its components and endpoints"
    width="850"
  />
</p>
