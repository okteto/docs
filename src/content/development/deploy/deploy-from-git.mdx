...
Note that your Git repository needs to be configured with an [Okteto Manifest](reference/okteto-manifest.mdx#dependencies-string-optional).
Read the Okteto Pipeline [getting started guide](development/using-okteto-cli.mdx#okteto-manifest) to learn how to create an Okteto Pipeline for your Git repository. -->

## Prerequisites

Please make sure to configure your Git repositories with the [appropriate manifests](development/using-okteto-cli.mdx#deployment-manifests) before using them to deploy Dev Environments.
