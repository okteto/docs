...
You can use Preview Environments with either [Okteto Cloud](welcome/overview.md) or with [Okteto Self-Hosted](self-hosted.mdx) if you want to run them on your Kubernetes infrastructure.
...
Preview environments deploy the code in a pull request to [Okteto](welcome/overview.md). You can configure the way your code gets deployed using the [Okteto manifest](cloud/okteto-cli.mdx#okteto-manifest)'s `deploy` section.
