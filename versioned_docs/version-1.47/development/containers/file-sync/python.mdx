...
<Image
  ...
  alt="Okteto dashboard showing the hello-world deployment running with endpoints and logs"
/>
...
<Image
  ...
  alt="PyCharm Debug console showing a successful connection to the pydev remote debugger on port 9000"
  width="850"
/>
...
<Image
  ...
  alt="PyCharm IDE paused at a breakpoint on line 10 of app.py, showing the call stack and variable inspector"
  width="850"
/>
