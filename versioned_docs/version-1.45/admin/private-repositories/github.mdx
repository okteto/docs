...
You can update or revoke the permissions over your private repositories or organizations by navigating to **Settings -> Integrations** in the Okteto Dashboard

<p align="left"><Image src={require('@site/static/img/private-repositories-update-sidebar+1.32.png').default} alt="Configure private repositories" /></p>
...
<p align="left"><Image src={require('@site/static/img/private-repositories-enable.png').default} alt="Add Github repositories to Okteto" width="650" /></p>
