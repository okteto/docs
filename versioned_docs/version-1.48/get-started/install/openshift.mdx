...
This restriction impacts the [Okteto Daemon](self-hosted/helm-configuration.mdx#daemonset) service.
...
The `extraRoleBindings` section allows your developers to use images that require `root` privileges in their development environments.
