...
When you deploy an application using the Catalog, Okteto automatically builds and deploys the repository, manifest path, and variables defined by your team. This is the equivalent of running `okteto deploy --file $PATH.yaml --var KEY=value` from your command line.
