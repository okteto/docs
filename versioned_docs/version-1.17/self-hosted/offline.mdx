...
We recommend that you follow Azure's [cluster creation guide](https://docs.microsoft.com/en-us/azure/aks/kubernetes-walkthrough) and check out our [AKS guide](get-started/cloud-provider-guides/aks.mdx).
