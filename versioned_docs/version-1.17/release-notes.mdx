...
- Added [configuration to set PSP and AppArmor](self-hosted/manage/upgrade.mdx)
...
- Allow [custom affinities](reference/helm-chart-values.mdx#affinity) in application pods
