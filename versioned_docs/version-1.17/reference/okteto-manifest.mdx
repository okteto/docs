...
Follow this document for a list of [environment variables](reference/okteto-cli.mdx#build) available in your deploy commands to refer to the images built in the `build` section of your Okteto Manifest.
