...
- Configure Access to your Okteto Namespace [using the Okteto CLI](core/credentials/kubernetes-credentials.mdx#download-your-kubernetes-credentials-using-the-okteto-cli) or [using the Okteto dashboard](core/credentials/kubernetes-credentials.mdx).
...
Head over to our getting started guides for [Go](guides/samples/golang.mdx#step-4-remote-development-with-okteto), [ASP.NET](guides/samples/aspnetcore.mdx#step-4-remote-debugging-with-okteto), [Java](guides/samples/java.mdx#step-4-remote-development-with-okteto), [Node.js](guides/samples/node.mdx#step-4-remote-debugging-with-okteto), [PHP](guides/samples/php.mdx#step-4-remote-debugging-with-okteto), [Python](guides/samples/python.mdx#step-4-remote-debugging-with-okteto), or [Ruby](guides/samples/ruby.mdx#step-4-remote-debugging-with-okteto) to see how to configure Okteto to live-update your application with different programming languages and **debuggers**.
