...
1. `OKTETO_TOKEN`: an Okteto [personal access token](/docs/previous/cloud/personal-access-tokens/).
...
1. Build and deploy the application using the [Okteto preview](/docs/previous/cloud/preview-environments/preview-environments/) defined in the repository.
1. Add the URL of the Preview Environment to the Merge Request.

The flow to delete a preview environment looks like this:

1. Destroy the application deployed with the [Okteto preview](/docs/previous/cloud/preview-environments/preview-environments/)
...
> Learn more about [the okteto CLI here](/docs/previous/reference/cli/).
...
Okteto makes it easy to deploy your own [Gitlab Runner](https://docs.gitlab.com/runner/) from the [Okteto Catalog](/docs/previous/cloud/deploy-from-helm/). Running your runners is useful if you find yourself constantly waiting for shared runners to be available or want to run more complex configurations.
