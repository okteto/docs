...
[This document](/docs/previous/cloud/credentials/) will walk you through the necessary steps for this.
...
[Take a look at this document](/docs/previous/cloud/multitenancy/) to understand the limitations and restrictions most likely to affect your applications in Okteto Cloud.
