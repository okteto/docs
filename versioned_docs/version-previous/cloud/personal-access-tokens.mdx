...
Personal Access Tokens are useful when scripting, or when configuring [Preview Environments](/docs/previous/cloud/preview-environments/preview-environments/).
...
Once you have a token, you can use it to authenticate with the [Okteto CLI](/docs/previous/reference/cli/) instead of using your browser, as shown below:
