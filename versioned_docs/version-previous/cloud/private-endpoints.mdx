...
<Tabs
  ...
  values={[
    ...
    { label: 'Okteto Stacks', value: 'stack', },
  ]}
>
...
> Private Endpoints generated this way follow the same rules and restrictions than [Automatic SSL Endpoints](/docs/previous/cloud/ssl/).
...
Private Endpoints is one of the extensions that Okteto added to [Okteto Stacks](/docs/previous/reference/stacks/) to make it easier to develop cloud-native applications. 
