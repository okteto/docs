...
You'll need the [okteto CLI](/docs/previous/cloud/okteto-cli/) in order to access the Okteto Build Service.
...
[Refer to this document](/docs/previous/reference/cli/#build) for more information on the `okteto build` command.
