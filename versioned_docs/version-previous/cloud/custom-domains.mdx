...
If you're using Okteto Cloud's [auto-ingress](/docs/previous/cloud/ssl/) or [generate the host](/docs/previous/cloud/ssl/#let-okteto-generate-the-host) features, then there's nothing to change. Just redeploy your application, and it will automatically pick up your custom domain.
