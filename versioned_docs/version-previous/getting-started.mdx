...
> Check the [docs](/docs/previous/cloud/okteto-pipeline/) to learn more about how to configure your `okteto-pipeline.yml` file.
...
More installation options are documented [here](/docs/previous/cloud/okteto-cli/).
...
The `okteto up` command starts a [development container](/docs/previous/reference/development-environment/) in Okteto Cloud, which means:
...
> All of this (and more) can be customized via the `okteto.yml` [manifest file](/docs/previous/reference/manifest/), which lives side by side with the application source code. Use the `.stignore` file to avoid synchronizing build artifacts, git metadata, or dependencies like `node_modules`.
...
Head over to our samples for [Go](/docs/previous/samples/golang/), [ASP.NET](/docs/previous/samples/aspnetcore), [Java](/docs/previous/samples/java/), [Node.js](/docs/previous/samples/node), [PHP](/docs/previous/samples/php/), [Python](/docs/previous/samples/python/), or [Ruby](/docs/previous/samples/ruby/) to see how to use Okteto to live-update your application with different programming languages and **debuggers**.
