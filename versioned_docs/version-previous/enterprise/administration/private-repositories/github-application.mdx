...
Add the values we generated in the previous steps to your existing [Helm configuration file](/docs/previous/enterprise/install/deployment/#configuration-file).
...
> You can also use the appId and clientId values of your GitHub application in the `auth.github` section of your Helm configuration file if you're using GitHub as your [authentication provider](/docs/previous/enterprise/install/deployment/#authentication).
...
When you click on it, you should see the list of repositories that you added in the previous step. [This document](/docs/previous/cloud/private-repositories/) has further information on how to deploy a private repository.
