...
Refer to the general [configuration documentation](/docs/previous/enterprise/administration/configuration/) for advanced configuration.

## Troubleshooting

See our [troubleshooting guide](/docs/previous/enterprise/install/troubleshooting/) for tips on how to troubleshoot your Okteto Enterprise instance.
