...
[Okteto Stacks](/docs/previous/reference/stacks/) are for developers who don't want to deal with the complexities of Kubernetes manifests.
...
`okteto stack deploy --build` automatically builds a new image tag using the [Okteto Build Service](/docs/previous/cloud/build/), pushes it to the [Okteto Registry](/docs/previous/cloud/registry/), and redeploys your application with the new image tag.
...
Read the docs for the [Okteto Stack Manifest](/docs/previous/reference/stacks/) and the [available Okteto Stack CLI commands](/docs/previous/reference/cli/#stack) to learn more about developing your application using Stacks.

Head over to our getting started guides for [Go](/docs/previous/samples/golang/#step-4-debug-directly-in-okteto-cloud), [ASP.NET](/docs/previous/samples/aspnetcore#step-4-debug-directly-in-okteto-cloud), [Java](/docs/previous/samples/java/#step-4-debug-directly-in-okteto-cloud), [Node.js](/docs/previous/samples/node#step-4-debug-directly-in-okteto-cloud), [PHP](/docs/previous/samples/php/#step-4-debug-directly-in-okteto-cloud), [Python](/docs/previous/samples/python/#step-4-debug-directly-in-okteto-cloud), or [Ruby](/docs/previous/samples/ruby/#step-4-debug-directly-in-okteto-cloud) to see how to configure Okteto to live-update your application with different programming languages and **debuggers**.
