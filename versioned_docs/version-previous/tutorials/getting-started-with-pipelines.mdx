...
This tutorial provides a step by step guide to configure an [Okteto Pipeline](/docs/previous/cloud/okteto-pipeline/).
...
- `type` tells Kubernetes how you want to expose your service. In this case, it will expose it externally through a Load Balancer. In you want to **expose your application using ingress**, check the [docs](/docs/previous/cloud/ssl/#bring-your-own-ingress).
...
- The first command builds the Docker image of the Hello World application and pushes the image to the [Okteto Registry](/docs/previous/cloud/registry/).
...
Read the Okteto Pipeline [documentation](/docs/previous/cloud/okteto-pipeline/) to learn more about the Okteto Pipeline yaml syntax, available tools, and environment variables that you can use as part of your Okteto Pipeline.
...
> You can make the deployment experience even smoother by adding a [Develop on Okteto](/docs/previous/cloud/develop-on-okteto-button/) button to the `README.md` file of your Git repository.
