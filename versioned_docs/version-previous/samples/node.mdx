...
- Install the Okteto CLI (>= 1.12.13). Follow this [guide](/docs/previous/cloud/okteto-cli/) if you haven't done it yet.
...
With the Node.js Sample App deployed, run the following command to create your [okteto manifest](/docs/previous/reference/manifest/):
