...
- Install the Okteto CLI >= 1.9.0. Follow this [guide](/docs/previous/cloud/okteto-cli/) if you haven't done it yet.
...
With the Java Sample App deployed, run the following command to create your [okteto manifest](/docs/previous/reference/manifest/):
...
- `image`: the image used by the development container. More information on development images [here](/docs/previous/reference/development-environment/)
