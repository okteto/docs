...
- Defining Private Registry credentials in Helm has been deprecated. Private Registry Credentials are now natively supported by Okteto and configurable in the Okteto UI. Credentials defined in Helm will be automatically migrated. More info [here](self-hosted/install/upgrade.mdx#upgrading-to-okteto-114x)
...
- Updates to [**Cloud Secret**](self-hosted/administration/configuration.mdx#cloud-provider-secret) now take immediate effect  <!-- 7032 -->
