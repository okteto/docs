...
Some examples of what the Okteto Platform manages are: [configuring secrets](/manifest/okteto-variables.mdx), adding [external resources](/manifest/external-resources.mdx) into your development environment, and build and push container images to the [Okteto Registry](/core/components/container-registry.mdx). For a more comprehensive list of features, check out our [docs](/self-hosted/).
