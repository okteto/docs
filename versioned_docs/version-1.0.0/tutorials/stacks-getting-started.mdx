...
[Okteto Stacks](/docs/reference/stacks/) are for developers who don't want to deal with the complexities of Kubernetes manifests.
...
`okteto stack deploy --build` automatically builds a new image tag using the [Okteto Build Service](/docs/cloud/build/), pushes it to the [Okteto Registry](/docs/cloud/registry/), and redeploys your application with the new image tag.
...
Read the docs for the [Okteto Stack Manifest](/docs/reference/stacks/) and the [available Okteto Stack CLI commands](/docs/reference/cli/#stack) to learn more about developing your application using Stacks.

Head over to our getting started guides for [Go](/docs/samples/golang/#step-4-debug-directly-in-okteto-cloud), [ASP.NET](/docs/samples/aspnetcore#step-4-debug-directly-in-okteto-cloud), [Java](/docs/samples/java/#step-4-debug-directly-in-okteto-cloud), [Node.js](/docs/samples/node#step-4-debug-directly-in-okteto-cloud), [PHP](/docs/samples/php/#step-4-debug-directly-in-okteto-cloud), [Python](/docs/samples/python/#step-4-debug-directly-in-okteto-cloud), or [Ruby](/docs/samples/ruby/#step-4-debug-directly-in-okteto-cloud) to see how to configure Okteto to live-update your application with different programming languages and **debuggers**.
