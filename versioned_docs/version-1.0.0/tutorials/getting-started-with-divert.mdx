...
This tutorial provides an introduction for using the divert option in [Okteto Manifests](/docs/reference/manifest/).
...
- Install the Okteto CLI. Follow this [guide](/docs/getting-started/installation/) if you haven't done it yet.
...
The [okteto-pipeline.yml](/docs/cloud/okteto-pipeline) file defines the steps to deploy the application.
