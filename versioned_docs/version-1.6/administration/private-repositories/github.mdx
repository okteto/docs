...
You can update or revoke the permissions over your private repositories or organizations by going to the `Integrations` tab in the `Settings` page of your Okteto instance.

<p align="center">
  <Image
    src={require("@site/static/img/private-repositories-update.png").default}
    alt="update private repositories"
    width="650"
  />
</p>
...
<p align="center">
  <Image
    ...
    alt="add repositories to Okteto"
    width="650"
  />
</p>
