...
The header can also be used to route messages to different queues and topics, redirect requests to services in other namespaces, dynamically select which database to read or write, etc. [This GitHub repository](https://github.com/okteto-community/divert-showcase/) includes several samples illustrating how you can leverage divert.
:::
