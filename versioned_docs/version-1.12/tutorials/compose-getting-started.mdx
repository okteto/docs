...
- Configure Access to your Okteto Namespace [using the Okteto CLI](cloud/credentials.mdx#download-your-kubernetes-credentials-using-the-okteto-cli) or [using the Okteto dashboard](cloud/credentials.mdx#download-your-kubernetes-credentials-using-the-okteto-cli).
...
Head over to our getting started guides for [Go](samples/golang.mdx#step-5-remote-debugging-with-okteto), [ASP.NET](samples/aspnetcore.mdx#step-4-remote-debugging-with-okteto), [Java](samples/java.mdx#step-4-remote-development-with-okteto), [Node.js](samples/node.mdx#step-4-remote-debugging-with-okteto), [PHP](samples/php.mdx#step-4-remote-debugging-with-okteto), [Python](samples/python.mdx#step-4-remote-debugging-with-okteto), or [Ruby](samples/ruby.mdx#step-4-remote-debugging-with-okteto) to see how to configure Okteto to live-update your application with different programming languages and **debuggers**.
