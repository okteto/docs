...
You can add them both as an [Admin Secret](administration/dashboard.mdx#secrets) (if you want everyone in your instance to be able to use them), or a [User Secret](cloud/secrets.mdx).
