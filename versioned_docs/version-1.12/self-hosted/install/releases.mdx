...
- Support for the annotation [dev.okteto.com/endpoints](cloud/ssl/#customizing-the-endpoints-shown-in-the-okteto-dashboard) to customize the endpoints shown in the Okteto UI.
