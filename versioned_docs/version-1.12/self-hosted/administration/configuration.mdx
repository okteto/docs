...
> You can also use a [secret](self-hosted/administration/configuration.mdx#secret) to store the license.
...
> You can also use a [secret](self-hosted/administration/configuration.mdx#secret) to store the sensitive part of these credentials.
