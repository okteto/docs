...
- Keep your infrastructure under control with the Okteto [Garbage Collector](/docs/0.13/administration/cleanup/) and the [Okteto Autoscaler](/docs/0.13/enterprise/administration/configuration/#autoscaler)

[** Okteto is free for small teams. Click here to get started**](/docs/0.13/enterprise/install/overview).
