...
Add the values we generated in the previous steps to your existing [Helm configuration file](enterprise/install/deployment.mdx#configuration-file).
...
> You can also use the appId and clientId values of your GitHub application in the `auth.github` section of your Helm configuration file if you're using GitHub as your [authentication provider](enterprise/install/deployment.mdx#authentication).
