...
- [Install Okteto in Amazon Elastic Kubernetes Service](enterprise/eks.mdx)
- [Install Okteto in Azure Kubernetes Service](enterprise/aks.mdx)
- [Install Okteto in Google Kubernetes Engine](enterprise/gke.mdx)
- [Install Okteto in DigitalOcean Kubernetes](enterprise/digitalocean.mdx)

## Troubleshooting

We've done our best to make Okteto easy to install and operate. [The troubleshooting page](enterprise/install/troubleshooting.mdx) has tips and tricks to help troubleshoot common issues.
...
Instructions on how to upgrade your Okteto instance [are available here](enterprise/install/upgrade.mdx).
