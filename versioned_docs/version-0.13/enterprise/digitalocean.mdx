...
Okteto supports OAuth providers like Google, Bitbucket, GitHub, or OpenID Connect to handle user authentication. All the supported configuration settings [are described here](/docs/0.13/enterprise/administration/configuration/#auth).
...
Refer to the general [configuration documentation](/docs/0.13/enterprise/administration/configuration/) for advanced configuration.
...
For further troubleshooting tips, see our [troubleshooting guide](/docs/0.13/enterprise/install/troubleshooting/).
