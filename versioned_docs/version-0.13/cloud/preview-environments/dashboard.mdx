...
Note that this method is not applicable for users of [Okteto Self-Hosted](/docs/0.13/enterprise) or Okteto for Teams. Please checkout [GitHub Actions](/docs/cloud/preview-environments/preview-environments-github) for configuring Preview Environments in those cases.
...
Select it and click the "Add" button. Additionally, you can also configure variables to configure your preview environment. These variables work just like the [built-in environment variables](/docs/cloud/okteto-cli/#built-in-environment-variables).
