...
You can use Preview Environments with either [Okteto Cloud](/docs/cloud) or with [Okteto Self-Hosted](/docs/0.14/enterprise) if you want to run them on your Kubernetes infrastructure.
