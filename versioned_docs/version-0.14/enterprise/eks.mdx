...
> You can also configure Okteto to assume a role instead of using access keys. Check the [AWS section in the configuration page](/docs/0.14/enterprise/administration/configuration/#cloud) to learn more.
