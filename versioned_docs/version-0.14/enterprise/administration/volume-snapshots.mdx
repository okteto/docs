...
To enable Volume Snapshots on your Okteto instance, update your `config.yaml` file with the following values, and run a [helm upgrade](enterprise/install/upgrade.mdx#upgrade-your-okteto-enterprise-instance) to apply the new configuration.
