...
To enable the custom image, update your `config.yaml` file with the following values, and run a [helm upgrade](/docs/0.14/enterprise/install/upgrade/#upgrade-your-okteto-enterprise-instance) to apply the new configuration.
