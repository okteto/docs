...
[Follow this document](self-hosted/administration/custom-installer-image.mdx) to update the configuration of your Okteto instance.
...
Commit the Okteto manifest that we created in the previous step to your repository, and push the changes to a remote branch. Then, deploy your Development Environment [directly from the Okteto dashboard](cloud/deploy-from-git.mdx).
