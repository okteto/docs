...
Also, the default MongoDB password is `password` instead of `change-me!`. Luckily, you can pass runtime configuration to your Development Environment using [Okteto Variables](core/okteto-variables.mdx).
...
Or even better, create an [Okteto Admin Variable](admin/dashboard.mdx#admin-variables) to make this variable available across all your Development Environments in Okteto.
