...
:::note
The Previews dashboard doesn't include a Scope column. It marks only personal-scope previews with a user icon next to the preview name. A preview with no icon has global scope, which is the default.
:::
