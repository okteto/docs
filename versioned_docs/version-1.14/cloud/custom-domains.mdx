...
:::caution
Formerly, custom domains were a feature offered within Okteto Cloud, but they are no longer supported on the platform. If you have a need for this specific Okteto feature, we recommend exploring our Scale or Enterprise solutions as an alternative.
:::
