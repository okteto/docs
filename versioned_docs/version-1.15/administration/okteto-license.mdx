...
:::note
You can also optionally include your Okteto license using [Cloud Secrets](/self-hosted/administration/configuration.mdx#store-sensitive-configuration-values-using-a-secret).
:::
