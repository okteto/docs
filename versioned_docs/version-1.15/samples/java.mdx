...
At the root of the directory, you'll find the `okteto.yaml` file. This describes how to [build](reference/manifest.mdx#build-object-optional), [deploy](reference/manifest.mdx#deploy-string-optional), and [develop](reference/manifest.mdx#dev-object-optional) the Java Sample App.
