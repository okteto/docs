...
The Okteto CLI 2.0 was introduced in [Okteto 0.11.0](self-hosted/install/releases.mdx#0110). Older versions of Okteto are not able to support version 2.0 of the CLI.
