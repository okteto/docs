...
> You can also [use a secret](self-hosted/administration/configuration.mdx#store-sensitive-configuration-values-using-a-secret) to store the clientSecret and the appPrivateKey.
