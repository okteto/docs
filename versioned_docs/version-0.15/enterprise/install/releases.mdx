...
- Enable [user pod preferred affinity](/docs/self-hosted/administration/configuration/#userpodaffinity) by default
...
- Disable the [helm catalog](https://www.okteto.com/docs/self-hosted/administration/configuration/#applications) on self-hosted installations by default. This makes installing CRDs not mandatory during cluster creation.
