...
> Okteto supports OAuth providers like Google, GitHub, or OpenID Connect to handle user authentication. For this guide, we'll focus on using GitHub. All the supported configuration settings [are described here](enterprise/administration/configuration.mdx#auth).
...
Download a copy of the [Okteto Civo configuration file](https://okteto.com/docs/self-hosted/civo/config.yaml), open it, and update the following values:
...
Refer to the general [configuration documentation](enterprise/administration/configuration.mdx) for advanced configuration.

## Troubleshooting

See our [troubleshooting guide](enterprise/install/troubleshooting.mdx) for tips on how to troubleshoot your Okteto instance.
