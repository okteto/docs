...
Refer to the general [configuration documentation](/docs/self-hosted/administration/configuration/) for advanced configuration.

## Troubleshooting

See our [troubleshooting guide](/docs/self-hosted/install/troubleshooting/) for tips on how to troubleshoot your Okteto instance.
