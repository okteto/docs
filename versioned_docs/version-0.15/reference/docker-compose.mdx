...
In addition, `okteto up` uses host volumes to infer the [sync paths](/docs/reference/manifest/#sync-string-required) between your local filesystem and your remote development container.
