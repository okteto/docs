...
Note that this method is not applicable for users of [Okteto Self-Hosted](enterprise.mdx) or Okteto for Teams. Please checkout [GitHub Actions](cloud/preview-environments/github.mdx) for configuring Preview Environments in those cases.
