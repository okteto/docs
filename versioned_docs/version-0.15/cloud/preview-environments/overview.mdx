...
You can use Preview Environments with either [Okteto Cloud](welcome/overview.md) or with [Okteto Self-Hosted](enterprise.mdx) if you want to run them on your Kubernetes infrastructure.
