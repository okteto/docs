...
- Keep your infrastructure under control with the Okteto [Garbage Collector](/docs/self-hosted/administration/cleanup/) and the [Okteto Autoscaler](/docs/self-hosted/administration/configuration/#autoscaler)

[** Okteto is free for small teams. Click here to get started**](/docs/self-hosted/install/overview).
