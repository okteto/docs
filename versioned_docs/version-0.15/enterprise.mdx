...
- Keep your infrastructure under control with the Okteto [Garbage Collector](/docs/administration/cleanup/) and the [Okteto Autoscaler](/docs/self-hosted/administration/configuration/#autoscaler)
