...
The 1.0.0 comes with two breaking changes, follow our [upgrade guide to 1.x](self-hosted/install/upgrade.mdx#upgrading-from-okteto-0x-to-1x) to reduce the disruption of the service to a minimum.
