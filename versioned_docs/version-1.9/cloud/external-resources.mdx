...
Note for `Admins`: We strongly recommend configuring external resource secrets in your [admin dashboard](/administration/dashboard.mdx#secrets) to centralize and manage these secrets securely.
