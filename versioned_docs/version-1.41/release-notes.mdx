...
- Removed the dependency on the Bitnami Redis Helm chart. Okteto now ships its own [Kubernetes templates to deploy Redis](self-hosted/helm-configuration.mdx#redis) <!-- 9663 -->
