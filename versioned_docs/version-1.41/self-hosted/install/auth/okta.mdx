...
## Configure Automatic User Deprovisioning
[Follow this guide](admin/integrations/okta-user-deprovisioning.mdx) to set up the Okta event hook for user deprovisioning.
