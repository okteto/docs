...
You can use Preview Environments with either [Okteto Cloud](/docs/cloud) or with [Okteto Self-Hosted](/docs/0.12/enterprise) if you want to run them on your Kubernetes infrastructure.
...
Preview environments deploy the code in a pull request to [Okteto Cloud](/docs/cloud/) or [Self-Hosted](/docs/0.12/enterprise/). You can configure the way your code gets deployed using the [Okteto manifest](/docs/cloud/okteto-cli/#okteto-manifest)'s `deploy` section.
