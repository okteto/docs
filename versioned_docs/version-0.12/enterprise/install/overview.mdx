...
- [Install Okteto Enterprise in Amazon Elastic Kubernetes Service](/docs/0.12/enterprise/eks/)
- [Install Okteto Enterprise in Azure Kubernetes Service](/docs/0.12/enterprise/aks/)
- [Install Okteto Enterprise in Google Kubernetes Engine](/docs/0.12/enterprise/gke/)
- [Install Okteto Enterprise in DigitalOcean Kubernetes](/docs/0.12/enterprise/do/)

## Troubleshooting

We've done our best to make Okteto Enterprise easy to install and operate. [The troubleshooting page](/docs/0.12/enterprise/install/troubleshooting/) has tips and tricks to help troubleshoot common issues.
...
1. [Preparation](/docs/0.12/enterprise/install/preparation/)
2. [Deployment](/docs/0.12/enterprise/install/deployment/)
...
Instructions on how to upgrade your Okteto Enterprise instance [are available here](/docs/0.12/enterprise/install/upgrade/).

Please review [the release notes before upgrading](/docs/0.12/enterprise/install/releases/). New features, known issues, and configuration changes will be listed there.
