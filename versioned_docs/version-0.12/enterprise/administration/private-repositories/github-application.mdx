...
Add the values we generated in the previous steps to your existing [Helm configuration file](/docs/0.12/enterprise/install/deployment/#configuration-file).
...
> You can also use the appId and clientId values of your GitHub application in the `auth.github` section of your Helm configuration file if you're using GitHub as your [authentication provider](/docs/0.12/enterprise/install/deployment/#authentication).
