...
With Okteto dashboardu can create and manage secure and isolated Kubernetes namespaces for you and your team.

Okteto dashboardll take care of all the required RBAC roles and bindings, resources quotas and limits, pod security policies, and network policies so everyone in your team can safely deploy and develop applications in Kubernetes.
...
SaaS single tenant and Self-Hosted customers can specify a global, default threshold for automatically sleeping a namespace in the [garbage collection](/self-hosted/administration/configuration.mdx/#gc) configuration.
