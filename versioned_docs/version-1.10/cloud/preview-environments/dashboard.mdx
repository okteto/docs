...
:::caution
This feature is only available on Okteto Cloud, a product that has been deprecated. These instructions do not apply to, and will not work for, SaaS or Self-Hosted customers. Please us the [GitHub Actions](/cloud/preview-environments/preview-environments-github/) instructions instead to setup Preview Environments in Okteto. This page will soon be deprecated as well.
:::
