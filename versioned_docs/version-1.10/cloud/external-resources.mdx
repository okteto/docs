...
Note for `Admins`: We strongly recommend configuring external resource secrets in your [admin dashboard](cloud/secrets.mdx) to centralize and manage these secrets securely.
