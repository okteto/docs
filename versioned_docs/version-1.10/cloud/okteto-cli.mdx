...
This example shows how to [build](reference/manifest.mdx#build-object-optional) the container image of the **api** microservice, how to [deploy](reference/manifest.mdx#deploy-string-optional) the application using its helm chart,
...
You can refer to the variables defined by your [dependencies](reference/manifest.mdx#dependencies-string-optional) using the following environment variables:
