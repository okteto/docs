...
Select it and click the "Add" button. Additionally, you can also configure variables you might be using in your [Okteto Pipeline](/docs/next/cloud/okteto-pipeline) to configure your deploys. These variables work just like the [built-in environment variables](/docs/next/cloud/okteto-pipeline/#built-in-environment-variables) for your Okteto Pipeline.
