...
Select it and click the "Add" button. Additionally, you can also configure variables to configure your preview environment. These variables work just like the [built-in environment variables](/docs/next/cloud/okteto-cli/#built-in-environment-variables).
