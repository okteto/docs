...
You'll need the [okteto CLI](/docs/getting-started/installation/) in order to access the Okteto Build Service.
...
[Refer to this document](/docs/reference/cli/#build) for more information on the `okteto build` command.
