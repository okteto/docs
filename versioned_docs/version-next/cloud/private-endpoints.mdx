...
Private Endpoints is one of the extensions that Okteto added to [Okteto Stacks](/docs/reference/stacks/) to make it easier to develop cloud-native applications. 
