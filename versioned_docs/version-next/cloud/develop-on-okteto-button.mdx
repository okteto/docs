...
sidebar_label: Adding A Develop On Okteto Button
...
The easiest way to validate this is to follow the instructions in the [Deploy from Git](/docs/next/cloud/deploy-from-git/) document.
...
- `filename`: The location of the [Okteto manifest](/docs/next/reference/manifest/) relative to the root of the repository. If not set, one of the [deployment related manifests](/docs/next/cloud/okteto-cli/#deployment-manifests) will be used.
