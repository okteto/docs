...
- `filename`: The location of  the [Okteto manifest](/docs/next/reference/manifest/) relative to the root of the repository. If not set, the [automatic deployment rules](/docs/next/cloud/okteto-cli/#deployment-manifests) will be applied.
