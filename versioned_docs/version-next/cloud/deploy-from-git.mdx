...
Note that your Git repository needs to be configured with an [Okteto Pipeline](/docs/next/cloud/okteto-pipeline/).
Read the Okteto Pipeline [getting started guide](/docs/next/cloud/okteto-cli/#okteto-manifest) to learn how to create an Okteto Pipeline for your Git repository. -->

## Prerequisites

Please make sure to configure your Git repositories with the [appropriate manifests](/docs/next/cloud/okteto-cli/#deployment-manifests) before using them to launch Dev Environments.
...
> Check the [Okteto Manifest](/docs/next/reference/manifest/) to learn more about how to configure your development environment deployment with an `okteto.yml` file.
...
- `filename`: The location of the [Okteto Manifest](/docs/next/reference/manifest) relative to the root of the repository.