...
Okteto Pipelines allow you to configure how your [Git repositories](/docs/next/cloud/deploy-from-git) get deployed to [Okteto Cloud](/docs/next/cloud/). You might want to use them if Okteto Cloud cannot detect how to deploy your application from your [deployment manifests](/docs/next/cloud/deploy-from-git#prerequisites) or simply when you want more control over how your application gets deployed. 
...
For example, the above example builds fresh docker images for the api and frontend components of the [Movies App](https://github.com/okteto/movies), pushes these images to the [Okteto Registry](/docs/next/cloud/registry/) and deploys the app with Helm.
