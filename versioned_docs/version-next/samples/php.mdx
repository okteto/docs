...
- Install the Okteto CLI (>= 1.12.13). Follow this [guide](/docs/next/cloud/okteto-cli/) if you haven't done it yet.
...
With the PHP Sample App deployed, run the following command to create your [okteto manifest](/docs/next/reference/manifest/):
...
The okteto up command starts a [development container](https://www.okteto.com/docs/reference/development-environment/), which means:
...
- A [file synchronization service](https://www.okteto.com/docs/reference/file-synchronization/) is created to keep your changes up-to-date between your local filesystem and your development container.
