...
The `okteto up` command starts a [development container](/docs/reference/development-environment/), which means:
...
> All of this (and more) can be customized via the `okteto.yml` [manifest file](/docs/reference/manifest/).
