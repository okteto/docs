...
- Install the Okteto CLI >= 1.9.0. Follow this [guide](/docs/next/cloud/okteto-cli/) if you haven't done it yet.
...
With the Java Sample App deployed, run the following command to create your [okteto manifest](/docs/next/reference/manifest/):
