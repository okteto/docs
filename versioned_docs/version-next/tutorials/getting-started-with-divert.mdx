...
This tutorial provides an introduction for using the divert option in [Okteto Manifests](/docs/next/reference/manifest/).
...
The [okteto-pipeline.yml](/docs/current/cloud/okteto-pipeline) file defines the steps to deploy the application.
