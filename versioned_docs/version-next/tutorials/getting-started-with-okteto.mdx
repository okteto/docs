...
This tutorial provides a step by step guide to configure an [Okteto Manifest](/docs/next/reference/manifest/).
...
- `type` tells Kubernetes how you want to expose your service. In this case, it will expose it externally through a Load Balancer. In you want to **expose your application using ingress**, check the [docs](/docs/next/cloud/ssl/#bring-your-own-ingress).
...
[Install](/docs/next/cloud/okteto-cli/) the Okteto CLI and configure access to Okteto Cloud:
...
The full reference for development containers is [here](/docs/next/reference/manifest/#dev-object-optional).
This is the meaning of the fields we are using here:

- `image`: the image used by the development container. More information on development images [here](/docs/next/reference/development-environments/).
...
Head over to our samples for [Go](/docs/next/samples/golang/), [ASP.NET](/docs/next/samples/aspnetcore), [Java](/docs/next/samples/java/), [Node.js](/docs/next/samples/node), [PHP](/docs/next/samples/php/), [Python](/docs/next/samples/python/), or [Ruby](/docs/next/samples/ruby/) to see how to use Okteto to live-update your application with different programming languages and **debuggers**.
