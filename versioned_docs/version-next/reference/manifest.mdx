...
<<<<<<< HEAD:versioned_docs/version-next/reference/manifest.mdx
- `image`: the name of the image to build and push. In clusters managed by Okteto is optional (if not specified, the [Okteto Registry](/docs/next/cloud/registry/) is used.
=======
...
>>>>>>> main:src/content/reference/manifest-v2.mdx
...
In order to refer to these images from anywhere in your [Okteto Manifest](/docs/next/cloud/okteto-cli/#okteto-manifest), you can use the following environment variables:
...
There is also an extended notation to deploy Docker Compose files and [endpoints](/docs/next/reference/compose/#endpoints-object-optional) as part of your development environment:
...
A list of development containers to define the behavior of [okteto up](/docs/next/reference/cli/#up) and synchronize your code in your development environment.
...
> More information on development images [here](/docs/next/reference/development-environments/)
...
> More information on how to use private images for your development container [is available here](/docs/next/reference/faqs/#how-to-use-private-images).
...
- `persistentVolume.enabled` must be `true` if you use [services](/docs/next/reference/manifest/#services-object-optional).
- `persistentVolume.enabled` must be `true` if you use [volumes](/docs/next/reference/manifest/#volumes-string-optional).
...
> Use the `.stignore` file on each local folder to avoid synchronizing build artifacts, dependencies, or git metadata. [More information is available here](/docs/next/reference/file-synchronization/)
...
> You can [use secrets](/docs/next/reference/manifest/#secrets-string-optional) if you need to synchronize a single file instead of a folder
