...
Runs a job in the cluster that clones your repository and executes [okteto deploy](/docs/next/reference/cli/#deploy) on it.
...
You need to be [logged in](/docs/next/reference/cli/#context) to Okteto before running this command.
...
_--file_ | (string) | The location of the okteto manifest. If not set, the [automatic deployment rules](/docs/next/cloud/okteto-cli/#deployment-manifests) will be applied.
...
Runs a job in the cluster that clones your repository and executes [okteto destroy](/docs/next/reference/cli/#destroy) on it.
