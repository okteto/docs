---
title: Install Okteto Enterprise in Google Kubernetes Engine
...
> Okteto Enterprise supports OAuth providers like Google, GitHub, or OpenID Connect to handle user authentication. For this guide, we will focus on using Google. All the supported configuration settings [are described here](/docs/next/enterprise/administration/configuration/#auth).
...
Download a copy of the [Okteto Enterprise GKE configuration file](https://okteto.com/docs/enterprise/gke/config.yaml), open it, and set the following values:
- Your `email`
