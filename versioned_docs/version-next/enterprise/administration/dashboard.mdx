...
The Secrets section of the Admin dashboard lets you define cluster-wide secrets. All the [deployment pipelines](/docs/next/cloud/okteto-pipeline/) will include the secrets defined here as environment variables.
