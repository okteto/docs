---
title: Install Okteto Enterprise in Azure Kubernetes Service
...
> Okteto Enterprise supports OAuth providers like Google, GitHub, or OpenID Connect to handle user authentication. For this guide, we'll focus on using GitHub. All the supported configuration settings [are described here](/docs/next/enterprise/administration/configuration/#auth).
...
Okteto Enterprise is free for small teams.  You get all the features of [Okteto Enterprise](/docs/next/enterprise/) for up to 3 users with 3 namespaces each.
...
For further troubleshooting tips, see our [troubleshooting guide](/docs/next/enterprise/install/troubleshooting/).
