---
title: Install Okteto Enterprise in Civo
...
<p align="center"><Image src="images/civo-apikey.png" width="650" /></p>
...
Download a copy of the [Okteto Enterprise Civo configuration file](https://okteto.com/docs/enterprise/civo/config.yaml), open it, and update the following values:
...
<p align="center"><Image src="images/civo-dns-records.png" width="650" /></p>
...
<p align="center"><Image src="images/civo-add-a-new-domain-record.png" width="650" /></p>
...
Refer to the general [configuration documentation](/docs/next/enterprise/administration/configuration/) for advanced configuration.

## Troubleshooting

See our [troubleshooting guide](/docs/next/enterprise/install/troubleshooting/) for tips on how to troubleshoot your Okteto Enterprise instance.
