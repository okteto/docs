...
- `cue` and `wait-for-it` are now available [on the git pipelines](/docs/next/cloud/okteto-pipeline/#built-in-tools).
...
### Features
- You can now define `deploy` and `destroy` commands on the [pipeline manifest](/docs/next/cloud/okteto-pipeline/#schema-reference).
...
- Username, user id, email, and commit sha are available as environment variables [in okteto pipelines](/docs/next/cloud/okteto-pipeline/)
