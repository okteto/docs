---
title: Install Okteto Enterprise in Amazon Elastic Kubernetes Service
...
> You can also configure Okteto to assume a role instead of using access keys. Check the [AWS section in the configuration page](/docs/next/enterprise/administration/configuration/#cloud) to learn more.
