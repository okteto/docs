...
Before clicking the `Launch` button, you are able to modify any of the values of the application. Use this if you want to launch a different branch, set different values for the pre-configured variables, or use a different Okteto manifest. 
...
To destroy the application, go to the  extended menu of your development environment and click the `Destroy` button.

A confirmation dialog will pop up. Click the `Destroy` button to delete your application and all the resources:
