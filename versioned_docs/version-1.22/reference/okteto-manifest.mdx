...
A list of commands to execute the tests. For tests to pass, all these commands should exit with a zero code, otherwise the Test Container is marked as failed.
