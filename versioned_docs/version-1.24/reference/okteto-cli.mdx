...
:::warning
[Okteto CLI 3.0](https://www.okteto.com/blog/cli-three-release/#how-can-i-try-okteto-cli-30) introduces some flag changes for `okteto deploy`
...
:::warning
Please note that `okteto init` will be deprecated in [Okteto CLI 3.0](https://www.okteto.com/blog/cli-three-release/#how-can-i-try-okteto-cli-30)
:::
...
:::warning
In [Okteto CLI 3.0](https://www.okteto.com/blog/cli-three-release/#how-can-i-try-okteto-cli-30) `okteto pipeline deploy` will default to `--wait=true`
:::
...
:::warning
In [Okteto CLI 3.0](https://www.okteto.com/blog/cli-three-release/#how-can-i-try-okteto-cli-30) `okteto pipeline destroy` will default to `--wait=true`
:::
...
:::warning
In [Okteto CLI 3.0](https://www.okteto.com/blog/cli-three-release/#how-can-i-try-okteto-cli-30) `okteto preview deploy` will default to `--wait=true`
:::
...
:::warning
In [Okteto CLI 3.0](https://www.okteto.com/blog/cli-three-release/#how-can-i-try-okteto-cli-30) `okteto preview destroy` will default to `--wait=true`
:::
...
:::warning
[Okteto CLI 3.0](https://www.okteto.com/blog/cli-three-release/#how-can-i-try-okteto-cli-30) introduces some flag changes for `okteto up`:
