...
Okteto Pipelines allow you to configure how your [Git repositories](cloud/deploy-from-git.mdx) get deployed to [Okteto Cloud](cloud.mdx). You might want to use them if Okteto Cloud cannot detect how to deploy your application from your [deployment manifests](cloud/deploy-from-git.mdx#prerequisites) or simply when you want more control over how your application gets deployed. 
