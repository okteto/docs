...
1. [Optional] `OKTETO_URL`: if you are using [Okteto Enterprise](/docs/0.11/enterprise/), specify the URL of your instance of Okteto Enterprise (e.g., https://okteto.dev.mycompany.com).
