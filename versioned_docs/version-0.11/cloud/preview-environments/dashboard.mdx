...
Note that this method is not applicable for users of [Okteto Self-Hosted](/docs/0.11/enterprise) or Okteto for Teams. Please checkout [GitHub Actions](/docs/cloud/preview-environments/preview-environments-github) for configuring Preview Environments in those cases.
