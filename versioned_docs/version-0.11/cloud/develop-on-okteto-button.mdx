...
- `filename`: The location of the [Okteto manifest](/docs/reference/manifest/) relative to the root of the repository. If not set, one of the [deployment related manifests](/docs/cloud/okteto-cli/#deployment-manifests) will be used.
