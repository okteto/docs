...
As part of the [free **Starter** plan](https://okteto.com/pricing) and in order to automatically save resources, inactive applications are automatically scaled to zero after 24 hours of inactivity.
