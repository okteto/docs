...
Download a copy of the [Okteto Enterprise EKS configuration file](eks/config.yaml), open it, and update the following values:
- Your `email`
...
> You can also configure Okteto to assume a role instead of using access keys. Check the [AWS section in the configuration page](enterprise/administration/configuration.mdx#cloud) to learn more.
