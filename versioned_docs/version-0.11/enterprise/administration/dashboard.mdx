...
You can use this information to configure [the autoscaler](/docs/0.11/enterprise/administration/configuration/#autoscaler).
...
- Mark the namespace as `persistent` to prevent it from being automatically scaled to zero or deleted by the [garbage collector](/docs/0.11/enterprise/administration/cleanup/#delete-unused-namespaces)
