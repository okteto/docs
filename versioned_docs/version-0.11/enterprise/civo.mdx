...
Download a copy of the [Okteto Enterprise Civo configuration file](civo/config.yaml), open it, and update the following values:
...
See our [troubleshooting guide](enterprise/install/troubleshooting.mdx) for tips on how to troubleshoot your Okteto Enterprise instance.
