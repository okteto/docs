...
Use the `clientId` and `clientSecret` that you created [in the previous step](/docs/0.11/enterprise/install/preparation/#authentication).
...
Further configuration settings [are described here](/docs/0.11/enterprise/administration/configuration/#auth).
</TabItem>
</Tabs>
...
Create a secret named `okteto-cloud-secret` to store the Cloud Provider credentials created [in the preparation step](/docs/0.11/enterprise/install/preparation/#authentication).
