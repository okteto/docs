...
- Allow [custom affinities](/docs/0.11/enterprise/administration/configuration/#affinities) in application pods
- Allow to "Wake" previews from the Okteto UI
- Add support for [Buildkit HPA](/docs/0.11/enterprise/administration/configuration/#buildkit) (Horizontal Pod Autoscaler)
