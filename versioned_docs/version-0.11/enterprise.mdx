...
- Keep your infrastructure under control with the Okteto [Garbage Collector](/docs/0.11/enterprise/administration/cleanup/) and the [Okteto Autoscaler](/docs/0.11/enterprise/administration/configuration/#autoscaler)

[** Okteto Enterprise is free for small teams. Click here to get started**](/docs/0.11/enterprise/install/overview).
