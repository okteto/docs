...
For Okteto Enterprise users, the endpoint will be available at:
```
https://$YOUR_OKTETO_ENTERPRISE/graphql
```
...
The full schema of our GraphQL API <a href="/docs/api/schema/">is available here</a>.
