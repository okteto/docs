...
> When writing your Kubernetes manifests, take into account the [multitenant Kubernetes restrictions](cloud/multitenancy.mdx) that we have in place to make Okteto Cloud a secure environment to run your applications.
