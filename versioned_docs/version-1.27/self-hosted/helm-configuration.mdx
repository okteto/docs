...
Please Note:
	...
	•	If you need to include specific tools or custom configurations, you can build and use a custom Docker image
	•	Ensure the image you specify is accessible by your Kubernetes cluster and compatible with the Okteto CLI
:::
