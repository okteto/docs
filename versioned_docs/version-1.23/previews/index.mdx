...
To unlock the full potential of Okteto Preview Environments, you can also combine it with our [testing infrastructure](reference/okteto-cli.mdx#test) and run integration test against your environments.
