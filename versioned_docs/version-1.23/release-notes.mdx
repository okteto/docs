...
- [Okteto CLI 2.30.0](https://github.com/okteto/okteto/releases/tag/2.30.0): You can now Build images using the `okteto build` command as part of your custom commands in the Okteto Manifest when executing a remote deploy/destroy. Previous to this, no image was being built
