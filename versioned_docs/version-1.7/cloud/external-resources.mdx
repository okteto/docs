...
(**[Okteto Self-Hosted](/self-hosted)** customers only) For Amazon AWS and Google GCP you can also configure service accounts for connecting external resources to Okteto. You can learn more about that [here (AWS)](/self-hosted/administration/configuration/#iam-role-for-service-account-recommended) and [here (GCP)](/self-hosted/administration/configuration/#workload-identity-recommended)
