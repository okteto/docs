...
<p align="center">
  <Image
    src={require("@site/static/img/gc_launch_dev_env.png").default}
    alt="launch a development environment from the Catalog"
    width="600"
  />
</p>
...
<p align="center">
  <Image
    src={require("@site/static/img/gc_view_env_vars.png").default}
...
<p align="center">
  <Image
    src={require("@site/static/img/redeploy-catalog.png").default}
