...
1. [Reconfigure your Okteto instance](#reconfiguring-your-okteto-enterprise-instance)
...
> You can also [use a secret](self-hosted/install/deployment.mdx#cloud-provider-secret) to store the clientSecret and the appPrivateKey.
...
> You can also use the appId and clientId values of your GitHub application in the `auth.github` section of your Helm configuration file if you're using GitHub as your [authentication provider](self-hosted/install/deployment.mdx#authentication).
