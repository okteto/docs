---
title: title: Getting Started with Okteto and Node.js
...
- Configure Access to your Okteto Cloud Namespace [using the Okteto CLI](cloud/credentials.mdx#download-your-kubernetes-credentials-using-the-okteto-cli) or [using the Okteto UI](cloud/credentials.mdx#download-your-kubernetes-credentials-from-the-okteto-cloud-ui).
