...
- Implementation of [Admin Access Tokens](https://www.okteto.com/docs/1.18/admin/dashboard/#admin-access-tokens)  <!-- 7636, 7630, 7651 -->

### Improvements

- Change default value of [ingress.forceIngressSubdomain](https://www.okteto.com/docs/1.18/reference/helm-chart-values/#ingress) to false. By default, Okteto won't force deployed applications to match [Okteto's subdomain](https://www.okteto.com/docs/1.18/get-started/deploy-your-app/endpoints/)    <!-- 7718 -->
