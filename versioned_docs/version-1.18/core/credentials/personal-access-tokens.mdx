...
**Important**: For shared automations, like [Preview Environments](preview/overview.mdx), it's recommended that you use [Admin Access Tokens](admin/dashboard.mdx#admin-access-tokens). They're created in the same way as described here, but through the [Admin dashboard](admin/dashboard.mdx#admin-access-tokens).
