...
- `upSessionByLastSyncedFile`: If true, okteto up sessions will be scaled to zero if not files have been synchronized in the scale to zero period. Default behavior is to check for an active connection (regardless of inactivity)
