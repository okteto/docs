...
The Okteto Manifest has a [build](manifest/overview-manifest.mdx#build) section to define how to build the image of my application.

The Okteto Manifest also has a [deploy](manifest/overview-manifest.mdx#deploy) section to define the sequence of commands to deploy the Hello World application.
...
Head over to [our getting started guides](deploy/development-containers/file-sync/index.mdx) to see how to configure Okteto to live-update your application with different programming languages and **debuggers**.
