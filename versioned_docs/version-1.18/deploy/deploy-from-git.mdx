...
Please make sure to configure your Git repositories with the [appropriate manifests](manifest/overview-manifest.mdx#deploy) before using them to deploy Dev Environments.
