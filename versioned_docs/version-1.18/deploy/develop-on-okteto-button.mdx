...
- `filename`: The location of the [Okteto manifest](reference/okteto-manifest.mdx) relative to the root of the repository. If not set, one of the [deployment related manifests](manifest/overview-manifest.mdx#deploy) will be used.
