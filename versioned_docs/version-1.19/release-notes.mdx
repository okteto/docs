...
- Okteto CLI: `okteto deploy` will now ignore host volumes. More information on this [community post](https://community.okteto.com/t/important-update-changes-to-docker-compose-deployment-behavior-in-okteto/1246).
