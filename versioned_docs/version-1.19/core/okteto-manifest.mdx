...
| [deploy](#deploy)             | Configure a list of commands to deploy your application. You can also refer to [Docker Compose](reference/okteto-manifest.mdx#deploy-with-compose) files                                                                                                                         |
