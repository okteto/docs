...
With the Java Sample App deployed, run the following command to create your [okteto manifest](/docs/0.10/reference/manifest/):
...
- `image`: the image used by the development container. More information on development images [here](/docs/0.10/reference/development-environment/)
