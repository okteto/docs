...
The `okteto up` command starts a [development container](/docs/0.10/reference/development-environment/), which means:
...
> All of this (and more) can be customized via the `okteto.yml` [manifest file](/docs/0.10/reference/manifest/).
