...
This tutorial provides an introduction for using the divert option in [Okteto Manifests](/docs/0.10/reference/manifest/).
...
The [okteto-pipeline.yml](/docs/0.10/cloud/okteto-pipeline) file defines the steps to deploy the application.
