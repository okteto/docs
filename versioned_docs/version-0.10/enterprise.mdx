...
- Get self-service access to your Kubernetes infrastructure. Forget about dealing with IAMs and account mappings and just login with your email account to get your [kubeconfig](/docs/0.10/cloud/credentials/).
...
[** Okteto Enterprise is free for small teams. Click here to get started**](/docs/0.10/enterprise/install/overview).
