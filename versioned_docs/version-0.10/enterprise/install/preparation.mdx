...
With the environment set up and configuration generated, you can now proceed to the [deployment of Okteto Enterprise](/docs/0.10/enterprise/install/deployment/).