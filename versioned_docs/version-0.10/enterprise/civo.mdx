...
Refer to the general [configuration documentation](/docs/0.10/enterprise/administration/configuration/) for advanced configuration.

## Troubleshooting

See our [troubleshooting guide](/docs/0.10/enterprise/install/troubleshooting/) for tips on how to troubleshoot your Okteto Enterprise instance.
