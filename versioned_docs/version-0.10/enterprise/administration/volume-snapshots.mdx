...
To enable Volume Snapshots on your Okteto Enterprise instance, update your `config.yaml` file with the following values, and run a [helm upgrade](/docs/0.10/enterprise/install/upgrade/#upgrade-your-okteto-enterprise-instance) to apply the new configuration.
