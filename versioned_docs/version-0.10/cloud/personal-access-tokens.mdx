...
Personal Access Tokens are useful when scripting, or when configuring [Preview Environments](/docs/0.10/cloud/preview-environments/preview-environments/).
...
Once you have a token, you can use it to authenticate with the [Okteto CLI](/docs/0.10/reference/cli/) instead of using your browser, as shown below:
