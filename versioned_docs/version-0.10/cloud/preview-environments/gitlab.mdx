...
1. [Optional] `OKTETO_URL`: if you are using [Okteto Enterprise](/docs/0.10/enterprise/), specify the URL of your instance of Okteto Enterprise (e.g., https://okteto.dev.mycompany.com).
...
1. Build and deploy the application using the [Okteto preview](/docs/0.10/cloud/preview-environments/preview-environments/) defined in the repository.
1. Add the URL of the Preview Environment to the Merge Request.

The flow to delete a preview environment looks like this:

1. Destroy the application deployed with the [Okteto preview](/docs/0.10/cloud/preview-environments/preview-environments/)
