...
After giving Okteto access to any of your public or private repositories, you'll be able to launch dev environments from a GitHub repository [using an Okteto Pipeline](/docs/0.10/cloud/okteto-pipeline/).
