...
> Private Endpoints generated this way follow the same rules and restrictions than [Automatic SSL Endpoints](/docs/0.10/cloud/ssl/).
...
Private Endpoints is one of the extensions that Okteto added to [Okteto Stacks](/docs/0.10/reference/stacks/) to make it easier to develop cloud-native applications. 
